...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	redisReadReplicaClient := repository.NewRedisReadReplicaClient(configConfig)
	concurrencyCache := repository.ProvideConcurrencyCache(redisClient, redisReadReplicaClient, configConfig)
	schedulerCache := repository.ProvideSchedulerCache(redisClient, redisReadReplicaClient, configConfig)
	...
	affiliateService := service.NewAffiliateService(affiliateRepository, settingService, apiKeyAuthCacheInvalidator, billingCacheService, subscriptionService)
	...
	providerHallReadRepository := repository.NewProviderHallReadRepository(db)
	providerHallRepository := repository.NewProviderHallRepository(client)
	providerHallFactRepository := repository.NewProviderHallFactRepository(db)
	serviceBuildInfo := provideServiceBuildInfo(buildInfo)
	providerHallCollector := service.ProvideProviderHallCollector(providerHallFactRepository, providerHallRepository, openAIGatewayService, serviceBuildInfo)
	providerHallAggregationRepository := repository.NewProviderHallAggregationRepository(db)
	leaderLockCache := repository.NewLeaderLockCache(redisClient)
	providerHallAggregator := service.ProvideProviderHallAggregator(providerHallAggregationRepository, providerHallFactRepository, providerHallRepository, db, leaderLockCache, configConfig)
	providerHallJobRepository := repository.NewProviderHallJobRepository(db)
	providerHallRunner := service.ProvideProviderHallRunner(providerHallJobRepository, providerHallRepository, db, leaderLockCache, configConfig, serviceBuildInfo)
	...
	providerHallService := service.ProvideProviderHallService(providerHallRepository, groupRepository, userRepository, apiKeyService, providerHallCollector, providerHallAggregator, providerHallRunner, accountRepository, accountTestService, compositeModelRouteRepository)
	providerHallQueryService := service.ProvideProviderHallQueryService(providerHallReadRepository, providerHallRepository, providerHallService, apiKeyService, openAIGatewayService, modelPricingResolver, providerHallJobRepository, settingService)
	providerHallUserHandler := handler.NewProviderHallUserHandler(providerHallQueryService)
	...
	providerHallAdminRepository := repository.NewProviderHallAdminRepository(db)
	providerHallHandler := admin.NewProviderHallHandler(providerHallService, providerHallRunner, providerHallJobRepository, providerHallCollector, providerHallAggregator, providerHallAdminRepository)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, configConfig, coordinator, providerHallCollector)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, providerHallUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, idempotencyCoordinator, idempotencyCleanupService)
	...
	v := provideCleanup(client, redisClient, redisReadReplicaClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, opsService, opsIngressRejectAggregator, apiKeyService, authCacheInvalidationWorker, schedulerSnapshotService, tokenRefreshService, accountExpiryService, cnProviderBalanceCheckService, openAICodexVersionSyncService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, batchImageCleanupService, batchImageWorkerRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner, channelMonitorV2Aggregator, providerHallCollector, providerHallAggregator, providerHallRunner, userPlatformQuotaUsageFlusher, upstreamBillingProbeService, ollamaCloudUsageService, auditLogService, promptService)
