...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	providerHallService := service.ProvideProviderHallService(providerHallRepository, groupRepository, userRepository, apiKeyService, providerHallCollector, providerHallAggregator, providerHallRunner)
