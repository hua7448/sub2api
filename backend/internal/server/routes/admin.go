...
func RegisterAdminRoutes(
	...
	admin.Use(middleware.AdminComplianceGuard(settingService))
	{
		...
		registerProviderHallRoutes(admin, h)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/:id/keep-status-active", h.Admin.Account.SetKeepStatusActive)
...
func registerSubscriptionRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	subscriptions := admin.Group("/subscriptions")
	{
		...
		subscriptions.POST("/reset-today-usage", h.Admin.Subscription.ResetTodayUsage)
...
func registerChannelRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	channels := admin.Group("/channels")
	{
		...
		channels.GET("/available", h.Admin.Channel.ListAvailable)
...
func registerAffiliateRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	affiliates := admin.Group("/affiliates")
	{
		...
		inviters := affiliates.Group("/inviters")
		{
			inviters.GET("", h.Admin.Affiliate.ListInviters)
			inviters.PUT("/:user_id/quota", h.Admin.Affiliate.AdjustUserQuota)
		}
