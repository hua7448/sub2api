...
func RegisterUserRoutes(
	...
	authenticated.Use(gin.HandlerFunc(auditLog))
	{
		...
		user := authenticated.Group("/user")
		{
			...
			user.POST("/aff/transfer-days", h.User.TransferAffiliateSubscriptionDays)
			user.GET("/aff/rebates", h.User.ListAffiliateRebateRecords)
			user.GET("/aff/transfers", h.User.ListAffiliateTransferRecords)
		...
		groups := authenticated.Group("/groups")
		{
			...
			groups.GET("/:id/models", h.APIKey.GetGroupModels)
		}
		...
		registerUserSubscriptionRoutes(authenticated, h, panelRateLimiter)
		registerProviderHallUserRoutes(authenticated, h, panelRateLimiter)
...
func registerUserSubscriptionRoutes(authenticated *gin.RouterGroup, h *handler.Handlers, panelRateLimiter *middleware.PanelRateLimiter) {
	subscriptions := authenticated.Group("/subscriptions")
	{
		...
		subscriptions.POST("/:id/reset-daily-quota", panelRateLimiter.DailyQuotaReset(), h.Subscription.ResetDailyQuota)
	}
}
