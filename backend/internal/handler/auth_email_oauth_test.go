...
func (r *oauthEmailAffiliateRepoStub) CountQualifiedInvitees(context.Context, int64) (int, error) {
	panic("unexpected CountQualifiedInvitees call")
}

func (r *oauthEmailAffiliateRepoStub) CountQualifiedInviteesExcluding(context.Context, int64, int64) (int, error) {
	panic("unexpected CountQualifiedInviteesExcluding call")
}

func (r *oauthEmailAffiliateRepoStub) AccrueSubscriptionDays(context.Context, int64, int64, int64, int, int, *int64) error {
	panic("unexpected AccrueSubscriptionDays call")
}

func (r *oauthEmailAffiliateRepoStub) TransferSubscriptionDays(context.Context, int64, int64) (int, error) {
	panic("unexpected TransferSubscriptionDays call")
}

func (r *oauthEmailAffiliateRepoStub) ListSubscriptionDaysQuota(context.Context, int64) ([]service.AffiliateSubscriptionDaysQuota, error) {
	panic("unexpected ListSubscriptionDaysQuota call")
}

func (r *oauthEmailAffiliateRepoStub) ListInviters(context.Context, service.AffiliateAdminFilter) ([]service.AffiliateInviterEntry, int64, error) {
	panic("unexpected ListInviters call")
}

func (r *oauthEmailAffiliateRepoStub) AdjustUserQuota(context.Context, int64, float64) error {
