...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.RegistrationPlusAliasDisabled != after.RegistrationPlusAliasDisabled {
		changed = append(changed, "registration_email_plus_alias_disabled")
	}
	if before.RegistrationAliasDisabled != after.RegistrationAliasDisabled {
		changed = append(changed, "registration_email_provider_alias_disabled")
	}
