...
func ProvideAdminHandlers(
	...
	providerHallHandler *admin.ProviderHallHandler,
...
func ProvideOpenAIGatewayHandler(
	...
	h.SetProviderHallCollector(providerHall)
	return h
}
...
// ProvideAPIKeyHandler creates APIKeyHandler with the optional group-models provider wired in.
func ProvideAPIKeyHandler(apiKeyService *service.APIKeyService, gatewayService *service.GatewayService) *APIKeyHandler {
	...
	h.SetGroupModelsProvider(gatewayService)
	return h
}
...
func ProvideHandlers(
	...
	providerHallUserHandler *ProviderHallUserHandler,
	...
	return &Handlers{
		...
		ProviderHall:     providerHallUserHandler,
		Admin:            adminHandlers,
