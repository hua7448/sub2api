...
type SystemSettings struct {
	...
	RegistrationPlusAliasDisabled       bool
	RegistrationAliasDisabled           bool
	...
	AffiliateMinQualifiedInvitees int
	...
	OpenAIAllowClaudeCodeCodexPlugin       bool   // Deprecated compatibility field; migrated into codex_cli_only whitelist.
...
type PublicSettings struct {
	...
	// ProviderHallEnabled mirrors the provider hall display switch (opt-in flag).
