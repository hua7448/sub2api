...
func TestBillingService_GPT56CacheWritePricingUsesBusinessMultiplier(t *testing.T) {
	tests := []struct {
		model             string
		input             float64
...
func TestPricingService_GPT56BusinessRatesOverrideRemoteTable(t *testing.T) {
	pricingSvc := &PricingService{pricingData: map[string]*LiteLLMModelPricing{
		"gpt-5.6-sol":   {InputCostPerToken: 99e-6},
...
func TestDefaultPricingIncludesBusinessGPT56Rates(t *testing.T) {
...
func TestGPT56DedicatedFallbacksUseBusinessRates(t *testing.T) {
	tests := []struct {
		model                             string
		input, cached, cacheWrite, output float64
	}{
...
func TestGetModelPricing_ClaudeOpus47FallsBackToOpus47FamilyPricing(t *testing.T) {
	opus47Pricing := &LiteLLMModelPricing{InputCostPerToken: 5e-6, OutputCostPerToken: 2.5e-5}
	svc := &PricingService{
		pricingData: map[string]*LiteLLMModelPricing{
	...
	got := svc.GetModelPricing("claude-opus-4-7-20260417")
	require.Same(t, opus47Pricing, got)
}

func TestGetModelPricing_ClaudeOpus48FallsBackToOpus47FamilyPricing(t *testing.T) {
	opus47Pricing := &LiteLLMModelPricing{InputCostPerToken: 5e-6, OutputCostPerToken: 2.5e-5}
	svc := &PricingService{
		pricingData: map[string]*LiteLLMModelPricing{
			"claude-opus-4-7": opus47Pricing,
	...
	got := svc.GetModelPricing("claude-opus-4-8-20260529")
	require.Same(t, opus47Pricing, got)
}
