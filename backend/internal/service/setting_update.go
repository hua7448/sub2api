...
func (s *SettingService) buildSystemSettingsUpdates(ctx context.Context, settings *SystemSettings) (map[string]string, error) {
	...
	updates[SettingKeyRegistrationPlusAliasDisabled] = strconv.FormatBool(settings.RegistrationPlusAliasDisabled)
	updates[SettingKeyRegistrationAliasDisabled] = strconv.FormatBool(settings.RegistrationAliasDisabled)
