...
func (s *PricingService) GetModelPricing(modelName string) *LiteLLMModelPricing {
	...
	// GPT-5.6 product-tier prices are operator-managed business rates. Keep them
	// ahead of the remotely refreshed price table so a sync cannot change billing.
	if pricing := matchOpenAIGPT56BusinessPricing(lookupCandidates[0]); pricing != nil {
		return pricing
	}
...
func matchOpenAIGPT56BusinessPricing(model string) *LiteLLMModelPricing {
	switch {
