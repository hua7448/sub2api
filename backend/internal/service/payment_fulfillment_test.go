...
func (r *paymentFulfillmentAffiliateRepoStub) AccrueQuota(_ context.Context, inviterID, inviteeUserID int64, amount float64, freezeHours int, sourceOrderID, _ *int64) (bool, error) {
...
func (r *paymentFulfillmentAffiliateRepoStub) AccrueSubscriptionDays(_ context.Context, inviterID, inviteeUserID int64, groupID int64, days int, freezeHours int, _ *int64) error {
	r.accrueCalls = append(r.accrueCalls, paymentFulfillmentAffiliateAccrueCall{
		inviterID:     inviterID,
		inviteeUserID: inviteeUserID,
		groupID:       groupID,
...
func (r *paymentFulfillmentAffiliateRepoStub) CountQualifiedInvitees(context.Context, int64) (int, error) {
	panic("unexpected CountQualifiedInvitees call")
}

func (r *paymentFulfillmentAffiliateRepoStub) CountQualifiedInviteesExcluding(context.Context, int64, int64) (int, error) {
	panic("unexpected CountQualifiedInviteesExcluding call")
}

func (r *paymentFulfillmentAffiliateRepoStub) TransferSubscriptionDays(context.Context, int64, int64) (int, error) {
	panic("unexpected TransferSubscriptionDays call")
}

func (r *paymentFulfillmentAffiliateRepoStub) ListSubscriptionDaysQuota(context.Context, int64) ([]AffiliateSubscriptionDaysQuota, error) {
	panic("unexpected ListSubscriptionDaysQuota call")
}

func (r *paymentFulfillmentAffiliateRepoStub) ListInviters(context.Context, AffiliateAdminFilter) ([]AffiliateInviterEntry, int64, error) {
	panic("unexpected ListInviters call")
}

func (r *paymentFulfillmentAffiliateRepoStub) AdjustUserQuota(context.Context, int64, float64) error {
