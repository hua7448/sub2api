...
type SettingService struct {
	...
	// providerHallDisplayReader publishes the hall display switch as a public
	// setting; the cache keeps the hall config off the settings hot path.
	providerHallDisplayReader ProviderHallDisplayReader
	providerHallDisplayCache  atomic.Value // *cachedProviderHallDisplay
