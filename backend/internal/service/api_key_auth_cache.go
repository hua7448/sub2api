...
type APIKeyAuthUserSnapshot struct {
	...
	// UserGroupRPMOverrideLoaded is true when the (user, group) lookup completed
	// successfully, including the no-row case represented by a nil override.
	UserGroupRPMOverrideLoaded bool `json:"user_group_rpm_override_loaded"`
}
