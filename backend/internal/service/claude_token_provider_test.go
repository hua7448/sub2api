...
func (s *claudeTokenCacheStub) AcquireRefreshLock(ctx context.Context, cacheKey, owner string, ttl time.Duration) (bool, error) {
...
func (s *claudeTokenCacheStub) ReleaseRefreshLock(ctx context.Context, cacheKey, owner string) error {
