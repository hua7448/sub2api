...
func (s *geminiTokenCacheStub) AcquireRefreshLock(ctx context.Context, cacheKey, owner string, ttl time.Duration) (bool, error) {
	return true, nil
}

func (s *geminiTokenCacheStub) ReleaseRefreshLock(ctx context.Context, cacheKey, owner string) error {
	return nil
}
