...
const (
	...
	AuditActionSubscriptionResetTodayUsage     = "admin.subscriptions.reset_today_usage"
	AuditActionUserSubscriptionResetDailyQuota = "user.subscriptions.reset_daily_quota"
)
