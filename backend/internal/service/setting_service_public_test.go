...
func TestSettingService_GetPublicSettings_RegistrationEmailPlusAliasDefaultsDisabled(t *testing.T) {
	svc := NewSettingService(&settingPublicRepoStub{values: map[string]string{}}, &config.Config{})

	settings, err := svc.GetPublicSettings(context.Background())
	require.NoError(t, err)
	require.True(t, settings.RegistrationPlusAliasDisabled)
}

func TestSettingService_GetPublicSettings_ExposesRegistrationEmailPlusAliasSetting(t *testing.T) {
	...
	settings, err := svc.GetPublicSettings(context.Background())
	require.NoError(t, err)
	require.False(t, settings.RegistrationPlusAliasDisabled)
}
