...
const (
	...
	AffiliateMinQualifiedInviteesDefault = 1     // 默认先积累 1 个有效客户，从第 2 个客户开始返利
	AffiliateMinQualifiedInviteesMax     = 100
)
...
// SettingKeyRegistrationAliasDisabled controls provider-specific alias blocking.
const SettingKeyRegistrationAliasDisabled = "registration_email_provider_alias_disabled"
...
const (
	...
	// 禁止使用带 +tag 的邮箱注册。
	SettingKeyRegistrationPlusAliasDisabled = "registration_email_plus_alias_disabled"
	...
	SettingKeyAffiliateMinQualifiedInvitees = "affiliate_min_qualified_invitees" // 最低有效邀请人数（0=无门槛）
