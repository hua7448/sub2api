...
func TestAccountIsSchedulable_TempUnschedulable(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "keep_status_active_ignores_temp_unschedulable",
			account: &Account{
				Status:                 StatusActive,
				Schedulable:            true,
				TempUnschedulableUntil: &future,
		...
		{
			name: "keep_status_active_does_not_override_manual_schedulable",
			account: &Account{
				Status:      StatusActive,
				Schedulable: false,
				Extra:       map[string]any{KeepStatusActiveExtraKey: true},
		...
		{
			name: "keep_status_active_string_fails_closed",
			account: &Account{
				Status:                 StatusActive,
				Schedulable:            true,
				TempUnschedulableUntil: &future,
		...
		{
			name: "keep_status_active_number_fails_closed",
			account: &Account{
				Status:                 StatusActive,
				Schedulable:            true,
				TempUnschedulableUntil: &future,
				Extra:                  map[string]any{KeepStatusActiveExtraKey: 1},
			},
			want: false,
		},
	}
