...
func (s *OpenAIGatewayService) forwardOpenAIWSV2(
	...
	// Session/full already carries the original body metadata. Its shared
	// writer fills missing header fields without discarding body-only values.
	...
	ProviderHallTrackerFromContext(ctx).RecordSubmission()
