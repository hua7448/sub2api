...
// SetDailyQuotaResetWeekStart sets the "daily_quota_reset_week_start" field.
func (_c *UserSubscriptionCreate) SetDailyQuotaResetWeekStart(v time.Time) *UserSubscriptionCreate {
	_c.mutation.SetDailyQuotaResetWeekStart(v)
	return _c
}

// SetNillableDailyQuotaResetWeekStart sets the "daily_quota_reset_week_start" field if the given value is not nil.
func (_c *UserSubscriptionCreate) SetNillableDailyQuotaResetWeekStart(v *time.Time) *UserSubscriptionCreate {
	if v != nil {
		_c.SetDailyQuotaResetWeekStart(*v)
	}
	return _c
}
...
func (_c *UserSubscriptionCreate) createSpec() (*UserSubscription, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.DailyQuotaResetWeekStart(); ok {
		_spec.SetField(usersubscription.FieldDailyQuotaResetWeekStart, field.TypeTime, value)
		_node.DailyQuotaResetWeekStart = &value
	}
...
// SetDailyQuotaResetWeekStart sets the "daily_quota_reset_week_start" field.
func (u *UserSubscriptionUpsert) SetDailyQuotaResetWeekStart(v time.Time) *UserSubscriptionUpsert {
	u.Set(usersubscription.FieldDailyQuotaResetWeekStart, v)
	return u
}

// UpdateDailyQuotaResetWeekStart sets the "daily_quota_reset_week_start" field to the value that was provided on create.
func (u *UserSubscriptionUpsert) UpdateDailyQuotaResetWeekStart() *UserSubscriptionUpsert {
	u.SetExcluded(usersubscription.FieldDailyQuotaResetWeekStart)
	return u
}

// ClearDailyQuotaResetWeekStart clears the value of the "daily_quota_reset_week_start" field.
func (u *UserSubscriptionUpsert) ClearDailyQuotaResetWeekStart() *UserSubscriptionUpsert {
	u.SetNull(usersubscription.FieldDailyQuotaResetWeekStart)
	return u
}
...
// SetDailyQuotaResetWeekStart sets the "daily_quota_reset_week_start" field.
func (u *UserSubscriptionUpsertOne) SetDailyQuotaResetWeekStart(v time.Time) *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.SetDailyQuotaResetWeekStart(v)
	})
}

// UpdateDailyQuotaResetWeekStart sets the "daily_quota_reset_week_start" field to the value that was provided on create.
func (u *UserSubscriptionUpsertOne) UpdateDailyQuotaResetWeekStart() *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.UpdateDailyQuotaResetWeekStart()
	})
}

// ClearDailyQuotaResetWeekStart clears the value of the "daily_quota_reset_week_start" field.
func (u *UserSubscriptionUpsertOne) ClearDailyQuotaResetWeekStart() *UserSubscriptionUpsertOne {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.ClearDailyQuotaResetWeekStart()
	})
}
...
// SetDailyQuotaResetWeekStart sets the "daily_quota_reset_week_start" field.
func (u *UserSubscriptionUpsertBulk) SetDailyQuotaResetWeekStart(v time.Time) *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.SetDailyQuotaResetWeekStart(v)
	})
}
...
// UpdateDailyQuotaResetWeekStart sets the "daily_quota_reset_week_start" field to the value that was provided on create.
func (u *UserSubscriptionUpsertBulk) UpdateDailyQuotaResetWeekStart() *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.UpdateDailyQuotaResetWeekStart()
	})
}
...
// ClearDailyQuotaResetWeekStart clears the value of the "daily_quota_reset_week_start" field.
func (u *UserSubscriptionUpsertBulk) ClearDailyQuotaResetWeekStart() *UserSubscriptionUpsertBulk {
	return u.Update(func(s *UserSubscriptionUpsert) {
		s.ClearDailyQuotaResetWeekStart()
	})
}
