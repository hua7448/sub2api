...
// The ProviderHallConfigFunc type is an adapter to allow the use of ordinary function as a Querier.
type ProviderHallConfigFunc func(context.Context, *ent.ProviderHallConfigQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f ProviderHallConfigFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.ProviderHallConfigQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.ProviderHallConfigQuery", q)
}

// The TraverseProviderHallConfig type is an adapter to allow the use of ordinary function as Traverser.
type TraverseProviderHallConfig func(context.Context, *ent.ProviderHallConfigQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseProviderHallConfig) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseProviderHallConfig) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ProviderHallConfigQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.ProviderHallConfigQuery", q)
}

// The ProviderHallGroupFunc type is an adapter to allow the use of ordinary function as a Querier.
type ProviderHallGroupFunc func(context.Context, *ent.ProviderHallGroupQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f ProviderHallGroupFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.ProviderHallGroupQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.ProviderHallGroupQuery", q)
}

// The TraverseProviderHallGroup type is an adapter to allow the use of ordinary function as Traverser.
type TraverseProviderHallGroup func(context.Context, *ent.ProviderHallGroupQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseProviderHallGroup) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseProviderHallGroup) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ProviderHallGroupQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.ProviderHallGroupQuery", q)
}

// The ProviderHallProbeKeyFunc type is an adapter to allow the use of ordinary function as a Querier.
type ProviderHallProbeKeyFunc func(context.Context, *ent.ProviderHallProbeKeyQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f ProviderHallProbeKeyFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.ProviderHallProbeKeyQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.ProviderHallProbeKeyQuery", q)
}

// The TraverseProviderHallProbeKey type is an adapter to allow the use of ordinary function as Traverser.
type TraverseProviderHallProbeKey func(context.Context, *ent.ProviderHallProbeKeyQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseProviderHallProbeKey) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseProviderHallProbeKey) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ProviderHallProbeKeyQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.ProviderHallProbeKeyQuery", q)
}

// The ProviderHallProfileFunc type is an adapter to allow the use of ordinary function as a Querier.
type ProviderHallProfileFunc func(context.Context, *ent.ProviderHallProfileQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f ProviderHallProfileFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.ProviderHallProfileQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.ProviderHallProfileQuery", q)
}

// The TraverseProviderHallProfile type is an adapter to allow the use of ordinary function as Traverser.
type TraverseProviderHallProfile func(context.Context, *ent.ProviderHallProfileQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseProviderHallProfile) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseProviderHallProfile) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ProviderHallProfileQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.ProviderHallProfileQuery", q)
}

// The ProviderHallTargetFunc type is an adapter to allow the use of ordinary function as a Querier.
type ProviderHallTargetFunc func(context.Context, *ent.ProviderHallTargetQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f ProviderHallTargetFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.ProviderHallTargetQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.ProviderHallTargetQuery", q)
}

// The TraverseProviderHallTarget type is an adapter to allow the use of ordinary function as Traverser.
type TraverseProviderHallTarget func(context.Context, *ent.ProviderHallTargetQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseProviderHallTarget) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseProviderHallTarget) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ProviderHallTargetQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.ProviderHallTargetQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.ProviderHallConfigQuery:
		return &query[*ent.ProviderHallConfigQuery, predicate.ProviderHallConfig, providerhallconfig.OrderOption]{typ: ent.TypeProviderHallConfig, tq: q}, nil
	case *ent.ProviderHallGroupQuery:
		return &query[*ent.ProviderHallGroupQuery, predicate.ProviderHallGroup, providerhallgroup.OrderOption]{typ: ent.TypeProviderHallGroup, tq: q}, nil
	case *ent.ProviderHallProbeKeyQuery:
		return &query[*ent.ProviderHallProbeKeyQuery, predicate.ProviderHallProbeKey, providerhallprobekey.OrderOption]{typ: ent.TypeProviderHallProbeKey, tq: q}, nil
	case *ent.ProviderHallProfileQuery:
		return &query[*ent.ProviderHallProfileQuery, predicate.ProviderHallProfile, providerhallprofile.OrderOption]{typ: ent.TypeProviderHallProfile, tq: q}, nil
	case *ent.ProviderHallTargetQuery:
		return &query[*ent.ProviderHallTargetQuery, predicate.ProviderHallTarget, providerhalltarget.OrderOption]{typ: ent.TypeProviderHallTarget, tq: q}, nil
	case *ent.ProxyQuery:
