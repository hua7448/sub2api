...
func (_u *UserSubscriptionUpdate) SetDailyQuotaResetWeekStart(v time.Time) *UserSubscriptionUpdate {
	_u.mutation.SetDailyQuotaResetWeekStart(v)
	return _u
}

// SetNillableDailyQuotaResetWeekStart sets the "daily_quota_reset_week_start" field if the given value is not nil.
func (_u *UserSubscriptionUpdate) SetNillableDailyQuotaResetWeekStart(v *time.Time) *UserSubscriptionUpdate {
	if v != nil {
		_u.SetDailyQuotaResetWeekStart(*v)
	}
	return _u
}

// ClearDailyQuotaResetWeekStart clears the value of the "daily_quota_reset_week_start" field.
func (_u *UserSubscriptionUpdate) ClearDailyQuotaResetWeekStart() *UserSubscriptionUpdate {
	_u.mutation.ClearDailyQuotaResetWeekStart()
	return _u
}
...
func (_u *UserSubscriptionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.DailyQuotaResetWeekStart(); ok {
		_spec.SetField(usersubscription.FieldDailyQuotaResetWeekStart, field.TypeTime, value)
	}
	if _u.mutation.DailyQuotaResetWeekStartCleared() {
		_spec.ClearField(usersubscription.FieldDailyQuotaResetWeekStart, field.TypeTime)
	}
...
// SetDailyQuotaResetWeekStart sets the "daily_quota_reset_week_start" field.
func (_u *UserSubscriptionUpdateOne) SetDailyQuotaResetWeekStart(v time.Time) *UserSubscriptionUpdateOne {
	_u.mutation.SetDailyQuotaResetWeekStart(v)
	return _u
}

// SetNillableDailyQuotaResetWeekStart sets the "daily_quota_reset_week_start" field if the given value is not nil.
func (_u *UserSubscriptionUpdateOne) SetNillableDailyQuotaResetWeekStart(v *time.Time) *UserSubscriptionUpdateOne {
	if v != nil {
		_u.SetDailyQuotaResetWeekStart(*v)
	}
	return _u
...
// ClearDailyQuotaResetWeekStart clears the value of the "daily_quota_reset_week_start" field.
func (_u *UserSubscriptionUpdateOne) ClearDailyQuotaResetWeekStart() *UserSubscriptionUpdateOne {
	_u.mutation.ClearDailyQuotaResetWeekStart()
	return _u
}
