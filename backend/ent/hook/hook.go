...
// The ProviderHallConfigFunc type is an adapter to allow the use of ordinary
// function as ProviderHallConfig mutator.
type ProviderHallConfigFunc func(context.Context, *ent.ProviderHallConfigMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProviderHallConfigFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProviderHallConfigMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProviderHallConfigMutation", m)
}

// The ProviderHallGroupFunc type is an adapter to allow the use of ordinary
// function as ProviderHallGroup mutator.
type ProviderHallGroupFunc func(context.Context, *ent.ProviderHallGroupMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProviderHallGroupFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProviderHallGroupMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProviderHallGroupMutation", m)
}

// The ProviderHallProbeKeyFunc type is an adapter to allow the use of ordinary
// function as ProviderHallProbeKey mutator.
type ProviderHallProbeKeyFunc func(context.Context, *ent.ProviderHallProbeKeyMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProviderHallProbeKeyFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProviderHallProbeKeyMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProviderHallProbeKeyMutation", m)
}

// The ProviderHallProfileFunc type is an adapter to allow the use of ordinary
// function as ProviderHallProfile mutator.
type ProviderHallProfileFunc func(context.Context, *ent.ProviderHallProfileMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProviderHallProfileFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProviderHallProfileMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProviderHallProfileMutation", m)
}

// The ProviderHallTargetFunc type is an adapter to allow the use of ordinary
// function as ProviderHallTarget mutator.
type ProviderHallTargetFunc func(context.Context, *ent.ProviderHallTargetMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProviderHallTargetFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProviderHallTargetMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProviderHallTargetMutation", m)
}
