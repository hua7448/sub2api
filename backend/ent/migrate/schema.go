...
var (
	...
	// ProviderHallConfigColumns holds the columns for the "provider_hall_config" table.
	ProviderHallConfigColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64},
		{Name: "collection_enabled", Type: field.TypeBool, Default: false},
		{Name: "display_enabled", Type: field.TypeBool, Default: false},
		{Name: "tasks_enabled", Type: field.TypeBool, Default: false},
		{Name: "auto_schedule_enabled", Type: field.TypeBool, Default: false},
		{Name: "default_model", Type: field.TypeString, Size: 200, Default: ""},
		{Name: "default_protocol", Type: field.TypeEnum, Enums: []string{"responses", "chat_completions", "messages"}, Default: "responses"},
		{Name: "default_range", Type: field.TypeEnum, Enums: []string{"6h", "24h", "7d", "30d"}, Default: "6h"},
		{Name: "gateway_origin", Type: field.TypeString, Size: 2048, Default: ""},
		{Name: "operator_user_id", Type: field.TypeInt64, Nullable: true},
		{Name: "daily_budget", Type: field.TypeString, SchemaType: map[string]string{"postgres": "numeric(20,8)"}},
		{Name: "expected_nodes", Type: field.TypeJSON},
		{Name: "version", Type: field.TypeInt64, Default: 1},
		{Name: "updated_by", Type: field.TypeInt64, Nullable: true},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	}
	// ProviderHallConfigTable holds the schema information for the "provider_hall_config" table.
	ProviderHallConfigTable = &schema.Table{
		Name:       "provider_hall_config",
		Columns:    ProviderHallConfigColumns,
		PrimaryKey: []*schema.Column{ProviderHallConfigColumns[0]},
	}
	// ProviderHallGroupsColumns holds the columns for the "provider_hall_groups" table.
	ProviderHallGroupsColumns = []*schema.Column{
		{Name: "group_id", Type: field.TypeInt64},
	...
	// ProviderHallGroupsTable holds the schema information for the "provider_hall_groups" table.
	ProviderHallGroupsTable = &schema.Table{
		Name:       "provider_hall_groups",
		Columns:    ProviderHallGroupsColumns,
		PrimaryKey: []*schema.Column{ProviderHallGroupsColumns[0]},
	}
	// ProviderHallProbeKeysColumns holds the columns for the "provider_hall_probe_keys" table.
	ProviderHallProbeKeysColumns = []*schema.Column{
		{Name: "api_key_id", Type: field.TypeInt64},
		{Name: "operator_user_id", Type: field.TypeInt64},
		{Name: "group_id", Type: field.TypeInt64},
		{Name: "registered_by", Type: field.TypeInt64},
		{Name: "registered_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	}
	// ProviderHallProbeKeysTable holds the schema information for the "provider_hall_probe_keys" table.
	ProviderHallProbeKeysTable = &schema.Table{
		Name:       "provider_hall_probe_keys",
		Columns:    ProviderHallProbeKeysColumns,
		PrimaryKey: []*schema.Column{ProviderHallProbeKeysColumns[0]},
	}
	// ProviderHallProfilesColumns holds the columns for the "provider_hall_profiles" table.
	ProviderHallProfilesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "model", Type: field.TypeString, Size: 200},
		{Name: "protocol", Type: field.TypeEnum, Enums: []string{"responses", "chat_completions", "messages"}},
		{Name: "supports_tools", Type: field.TypeBool, Default: false},
		{Name: "output_limit", Type: field.TypeInt, Default: 256},
		{Name: "model_aliases", Type: field.TypeJSON},
		{Name: "reference_input_price", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "numeric(24,10)"}},
		{Name: "reference_cache_price", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "numeric(24,10)"}},
		{Name: "reference_cache_rate", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "numeric(11,10)"}},
		{Name: "reference_confirmed_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "version", Type: field.TypeInt64, Default: 1},
		{Name: "updated_by", Type: field.TypeInt64, Nullable: true},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	}
	// ProviderHallProfilesTable holds the schema information for the "provider_hall_profiles" table.
	ProviderHallProfilesTable = &schema.Table{
		Name:       "provider_hall_profiles",
		Columns:    ProviderHallProfilesColumns,
		PrimaryKey: []*schema.Column{ProviderHallProfilesColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "providerhallprofile_model_protocol",
				Unique:  true,
				Columns: []*schema.Column{ProviderHallProfilesColumns[1], ProviderHallProfilesColumns[2]},
			},
		},
	}
	// ProviderHallTargetsColumns holds the columns for the "provider_hall_targets" table.
	ProviderHallTargetsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "group_id", Type: field.TypeInt64},
		{Name: "profile_id", Type: field.TypeInt64},
		{Name: "probe_key_id", Type: field.TypeInt64, Nullable: true},
		{Name: "enabled", Type: field.TypeBool, Default: false},
		{Name: "auto_schedule_enabled", Type: field.TypeBool, Default: false},
		{Name: "probe_interval_seconds", Type: field.TypeInt, Default: 300},
		{Name: "verification_interval_seconds", Type: field.TypeInt, Default: 86400},
		{Name: "version", Type: field.TypeInt64, Default: 1},
		{Name: "updated_by", Type: field.TypeInt64, Nullable: true},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
	}
	// ProviderHallTargetsTable holds the schema information for the "provider_hall_targets" table.
	ProviderHallTargetsTable = &schema.Table{
		Name:       "provider_hall_targets",
		Columns:    ProviderHallTargetsColumns,
		PrimaryKey: []*schema.Column{ProviderHallTargetsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "providerhalltarget_group_id_profile_id",
				Unique:  true,
				Columns: []*schema.Column{ProviderHallTargetsColumns[1], ProviderHallTargetsColumns[2]},
			},
			{
				Name:    "providerhalltarget_probe_key_id",
				Unique:  false,
				Columns: []*schema.Column{ProviderHallTargetsColumns[3]},
			},
		},
	}
	...
	UserSubscriptionsColumns = []*schema.Column{
		...
		{Name: "weekly_window_start", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "monthly_window_start", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "daily_quota_reset_week_start", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "daily_usage_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "weekly_usage_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "monthly_usage_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
	...
	Tables = []*schema.Table{
		...
		ProviderHallConfigTable,
		ProviderHallGroupsTable,
		ProviderHallProbeKeysTable,
		ProviderHallProfilesTable,
		ProviderHallTargetsTable,
		ProxiesTable,
		RedeemCodesTable,
...
func init() {
	...
	ProviderHallConfigTable.Annotation = &entsql.Annotation{
		Table: "provider_hall_config",
	}
	ProviderHallConfigTable.Annotation.Checks = map[string]string{
		"provider_hall_config_budget_nonnegative": "daily_budget >= 0",
		"provider_hall_config_singleton":          "id = 1",
	}
	ProviderHallGroupsTable.Annotation = &entsql.Annotation{
		Table: "provider_hall_groups",
	}
	ProviderHallProbeKeysTable.Annotation = &entsql.Annotation{
		Table: "provider_hall_probe_keys",
	}
	ProviderHallProfilesTable.Annotation = &entsql.Annotation{
		Table: "provider_hall_profiles",
	}
	ProviderHallProfilesTable.Annotation.Checks = map[string]string{
	...
	ProviderHallTargetsTable.Annotation = &entsql.Annotation{
		Table: "provider_hall_targets",
	}
	ProviderHallTargetsTable.Annotation.Checks = map[string]string{
