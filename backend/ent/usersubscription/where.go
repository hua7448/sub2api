...
// DailyQuotaResetWeekStart applies equality check predicate on the "daily_quota_reset_week_start" field. It's identical to DailyQuotaResetWeekStartEQ.
func DailyQuotaResetWeekStart(v time.Time) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldEQ(FieldDailyQuotaResetWeekStart, v))
}
...
// DailyQuotaResetWeekStartEQ applies the EQ predicate on the "daily_quota_reset_week_start" field.
func DailyQuotaResetWeekStartEQ(v time.Time) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldEQ(FieldDailyQuotaResetWeekStart, v))
}

// DailyQuotaResetWeekStartNEQ applies the NEQ predicate on the "daily_quota_reset_week_start" field.
func DailyQuotaResetWeekStartNEQ(v time.Time) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldNEQ(FieldDailyQuotaResetWeekStart, v))
}

// DailyQuotaResetWeekStartIn applies the In predicate on the "daily_quota_reset_week_start" field.
func DailyQuotaResetWeekStartIn(vs ...time.Time) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldIn(FieldDailyQuotaResetWeekStart, vs...))
}

// DailyQuotaResetWeekStartNotIn applies the NotIn predicate on the "daily_quota_reset_week_start" field.
func DailyQuotaResetWeekStartNotIn(vs ...time.Time) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldNotIn(FieldDailyQuotaResetWeekStart, vs...))
}

// DailyQuotaResetWeekStartGT applies the GT predicate on the "daily_quota_reset_week_start" field.
func DailyQuotaResetWeekStartGT(v time.Time) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldGT(FieldDailyQuotaResetWeekStart, v))
}

// DailyQuotaResetWeekStartGTE applies the GTE predicate on the "daily_quota_reset_week_start" field.
func DailyQuotaResetWeekStartGTE(v time.Time) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldGTE(FieldDailyQuotaResetWeekStart, v))
}

// DailyQuotaResetWeekStartLT applies the LT predicate on the "daily_quota_reset_week_start" field.
func DailyQuotaResetWeekStartLT(v time.Time) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldLT(FieldDailyQuotaResetWeekStart, v))
}

// DailyQuotaResetWeekStartLTE applies the LTE predicate on the "daily_quota_reset_week_start" field.
func DailyQuotaResetWeekStartLTE(v time.Time) predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldLTE(FieldDailyQuotaResetWeekStart, v))
}

// DailyQuotaResetWeekStartIsNil applies the IsNil predicate on the "daily_quota_reset_week_start" field.
func DailyQuotaResetWeekStartIsNil() predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldIsNull(FieldDailyQuotaResetWeekStart))
}

// DailyQuotaResetWeekStartNotNil applies the NotNil predicate on the "daily_quota_reset_week_start" field.
func DailyQuotaResetWeekStartNotNil() predicate.UserSubscription {
	return predicate.UserSubscription(sql.FieldNotNull(FieldDailyQuotaResetWeekStart))
}
