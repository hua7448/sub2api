...
const (
	...
	// FieldDailyQuotaResetWeekStart holds the string denoting the daily_quota_reset_week_start field in the database.
	FieldDailyQuotaResetWeekStart = "daily_quota_reset_week_start"
...
// ByDailyQuotaResetWeekStart orders the results by the daily_quota_reset_week_start field.
func ByDailyQuotaResetWeekStart(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldDailyQuotaResetWeekStart, opts...).ToFunc()
}
