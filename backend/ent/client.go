...
type Client struct {
	...
	// ProviderHallConfig is the client for interacting with the ProviderHallConfig builders.
	ProviderHallConfig *ProviderHallConfigClient
	// ProviderHallGroup is the client for interacting with the ProviderHallGroup builders.
	ProviderHallGroup *ProviderHallGroupClient
	// ProviderHallProbeKey is the client for interacting with the ProviderHallProbeKey builders.
	ProviderHallProbeKey *ProviderHallProbeKeyClient
	// ProviderHallProfile is the client for interacting with the ProviderHallProfile builders.
	ProviderHallProfile *ProviderHallProfileClient
	// ProviderHallTarget is the client for interacting with the ProviderHallTarget builders.
	ProviderHallTarget *ProviderHallTargetClient
...
func (c *Client) init() {
	...
	c.ProviderHallConfig = NewProviderHallConfigClient(c.config)
	c.ProviderHallGroup = NewProviderHallGroupClient(c.config)
	c.ProviderHallProbeKey = NewProviderHallProbeKeyClient(c.config)
	c.ProviderHallProfile = NewProviderHallProfileClient(c.config)
	c.ProviderHallTarget = NewProviderHallTargetClient(c.config)
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		...
		ProviderHallConfig:            NewProviderHallConfigClient(cfg),
		ProviderHallGroup:             NewProviderHallGroupClient(cfg),
		ProviderHallProbeKey:          NewProviderHallProbeKeyClient(cfg),
		ProviderHallProfile:           NewProviderHallProfileClient(cfg),
		ProviderHallTarget:            NewProviderHallTargetClient(cfg),
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.ProviderHallConfig, c.ProviderHallGroup, c.ProviderHallProbeKey,
		c.ProviderHallProfile, c.ProviderHallTarget, c.Proxy, c.RedeemCode,
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	case *ProviderHallConfigMutation:
		return c.ProviderHallConfig.mutate(ctx, m)
	case *ProviderHallGroupMutation:
		return c.ProviderHallGroup.mutate(ctx, m)
	case *ProviderHallProbeKeyMutation:
		return c.ProviderHallProbeKey.mutate(ctx, m)
	case *ProviderHallProfileMutation:
		return c.ProviderHallProfile.mutate(ctx, m)
	case *ProviderHallTargetMutation:
		return c.ProviderHallTarget.mutate(ctx, m)
	case *ProxyMutation:
...
// ProviderHallConfigClient is a client for the ProviderHallConfig schema.
type ProviderHallConfigClient struct {
	config
}

// NewProviderHallConfigClient returns a client for the ProviderHallConfig from the given config.
func NewProviderHallConfigClient(c config) *ProviderHallConfigClient {
	return &ProviderHallConfigClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `providerhallconfig.Hooks(f(g(h())))`.
func (c *ProviderHallConfigClient) Use(hooks ...Hook) {
	c.hooks.ProviderHallConfig = append(c.hooks.ProviderHallConfig, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `providerhallconfig.Intercept(f(g(h())))`.
func (c *ProviderHallConfigClient) Intercept(interceptors ...Interceptor) {
	c.inters.ProviderHallConfig = append(c.inters.ProviderHallConfig, interceptors...)
}

// Create returns a builder for creating a ProviderHallConfig entity.
func (c *ProviderHallConfigClient) Create() *ProviderHallConfigCreate {
	mutation := newProviderHallConfigMutation(c.config, OpCreate)
	return &ProviderHallConfigCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of ProviderHallConfig entities.
func (c *ProviderHallConfigClient) CreateBulk(builders ...*ProviderHallConfigCreate) *ProviderHallConfigCreateBulk {
	return &ProviderHallConfigCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *ProviderHallConfigClient) MapCreateBulk(slice any, setFunc func(*ProviderHallConfigCreate, int)) *ProviderHallConfigCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ProviderHallConfigCreateBulk{err: fmt.Errorf("calling to ProviderHallConfigClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*ProviderHallConfigCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for ProviderHallConfig.
func (c *ProviderHallConfigClient) Update() *ProviderHallConfigUpdate {
	mutation := newProviderHallConfigMutation(c.config, OpUpdate)
	return &ProviderHallConfigUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *ProviderHallConfigClient) UpdateOne(_m *ProviderHallConfig) *ProviderHallConfigUpdateOne {
	mutation := newProviderHallConfigMutation(c.config, OpUpdateOne, withProviderHallConfig(_m))
	return &ProviderHallConfigUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *ProviderHallConfigClient) UpdateOneID(id int64) *ProviderHallConfigUpdateOne {
	mutation := newProviderHallConfigMutation(c.config, OpUpdateOne, withProviderHallConfigID(id))
	return &ProviderHallConfigUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for ProviderHallConfig.
func (c *ProviderHallConfigClient) Delete() *ProviderHallConfigDelete {
	mutation := newProviderHallConfigMutation(c.config, OpDelete)
	return &ProviderHallConfigDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *ProviderHallConfigClient) DeleteOne(_m *ProviderHallConfig) *ProviderHallConfigDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *ProviderHallConfigClient) DeleteOneID(id int64) *ProviderHallConfigDeleteOne {
	builder := c.Delete().Where(providerhallconfig.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ProviderHallConfigDeleteOne{builder}
}

// Query returns a query builder for ProviderHallConfig.
func (c *ProviderHallConfigClient) Query() *ProviderHallConfigQuery {
	return &ProviderHallConfigQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeProviderHallConfig},
		inters: c.Interceptors(),
	}
}

// Get returns a ProviderHallConfig entity by its id.
func (c *ProviderHallConfigClient) Get(ctx context.Context, id int64) (*ProviderHallConfig, error) {
	return c.Query().Where(providerhallconfig.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ProviderHallConfigClient) GetX(ctx context.Context, id int64) *ProviderHallConfig {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *ProviderHallConfigClient) Hooks() []Hook {
	return c.hooks.ProviderHallConfig
}

// Interceptors returns the client interceptors.
func (c *ProviderHallConfigClient) Interceptors() []Interceptor {
	return c.inters.ProviderHallConfig
}

func (c *ProviderHallConfigClient) mutate(ctx context.Context, m *ProviderHallConfigMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ProviderHallConfigCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&ProviderHallConfigUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&ProviderHallConfigUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ProviderHallConfigDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown ProviderHallConfig mutation op: %q", m.Op())
	}
}

// ProviderHallGroupClient is a client for the ProviderHallGroup schema.
type ProviderHallGroupClient struct {
	config
}

// NewProviderHallGroupClient returns a client for the ProviderHallGroup from the given config.
func NewProviderHallGroupClient(c config) *ProviderHallGroupClient {
	return &ProviderHallGroupClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `providerhallgroup.Hooks(f(g(h())))`.
func (c *ProviderHallGroupClient) Use(hooks ...Hook) {
	c.hooks.ProviderHallGroup = append(c.hooks.ProviderHallGroup, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `providerhallgroup.Intercept(f(g(h())))`.
func (c *ProviderHallGroupClient) Intercept(interceptors ...Interceptor) {
	c.inters.ProviderHallGroup = append(c.inters.ProviderHallGroup, interceptors...)
}

// Create returns a builder for creating a ProviderHallGroup entity.
func (c *ProviderHallGroupClient) Create() *ProviderHallGroupCreate {
	mutation := newProviderHallGroupMutation(c.config, OpCreate)
	return &ProviderHallGroupCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of ProviderHallGroup entities.
func (c *ProviderHallGroupClient) CreateBulk(builders ...*ProviderHallGroupCreate) *ProviderHallGroupCreateBulk {
	return &ProviderHallGroupCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *ProviderHallGroupClient) MapCreateBulk(slice any, setFunc func(*ProviderHallGroupCreate, int)) *ProviderHallGroupCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ProviderHallGroupCreateBulk{err: fmt.Errorf("calling to ProviderHallGroupClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*ProviderHallGroupCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for ProviderHallGroup.
func (c *ProviderHallGroupClient) Update() *ProviderHallGroupUpdate {
	mutation := newProviderHallGroupMutation(c.config, OpUpdate)
	return &ProviderHallGroupUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *ProviderHallGroupClient) UpdateOne(_m *ProviderHallGroup) *ProviderHallGroupUpdateOne {
	mutation := newProviderHallGroupMutation(c.config, OpUpdateOne, withProviderHallGroup(_m))
	return &ProviderHallGroupUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *ProviderHallGroupClient) UpdateOneID(id int64) *ProviderHallGroupUpdateOne {
	mutation := newProviderHallGroupMutation(c.config, OpUpdateOne, withProviderHallGroupID(id))
	return &ProviderHallGroupUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for ProviderHallGroup.
func (c *ProviderHallGroupClient) Delete() *ProviderHallGroupDelete {
	mutation := newProviderHallGroupMutation(c.config, OpDelete)
	return &ProviderHallGroupDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *ProviderHallGroupClient) DeleteOne(_m *ProviderHallGroup) *ProviderHallGroupDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *ProviderHallGroupClient) DeleteOneID(id int64) *ProviderHallGroupDeleteOne {
	builder := c.Delete().Where(providerhallgroup.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ProviderHallGroupDeleteOne{builder}
}

// Query returns a query builder for ProviderHallGroup.
func (c *ProviderHallGroupClient) Query() *ProviderHallGroupQuery {
	return &ProviderHallGroupQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeProviderHallGroup},
		inters: c.Interceptors(),
	}
}

// Get returns a ProviderHallGroup entity by its id.
func (c *ProviderHallGroupClient) Get(ctx context.Context, id int64) (*ProviderHallGroup, error) {
	return c.Query().Where(providerhallgroup.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ProviderHallGroupClient) GetX(ctx context.Context, id int64) *ProviderHallGroup {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *ProviderHallGroupClient) Hooks() []Hook {
	return c.hooks.ProviderHallGroup
}

// Interceptors returns the client interceptors.
func (c *ProviderHallGroupClient) Interceptors() []Interceptor {
	return c.inters.ProviderHallGroup
}

func (c *ProviderHallGroupClient) mutate(ctx context.Context, m *ProviderHallGroupMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ProviderHallGroupCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&ProviderHallGroupUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&ProviderHallGroupUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ProviderHallGroupDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown ProviderHallGroup mutation op: %q", m.Op())
	}
}

// ProviderHallProbeKeyClient is a client for the ProviderHallProbeKey schema.
type ProviderHallProbeKeyClient struct {
	config
}

// NewProviderHallProbeKeyClient returns a client for the ProviderHallProbeKey from the given config.
func NewProviderHallProbeKeyClient(c config) *ProviderHallProbeKeyClient {
	return &ProviderHallProbeKeyClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `providerhallprobekey.Hooks(f(g(h())))`.
func (c *ProviderHallProbeKeyClient) Use(hooks ...Hook) {
	c.hooks.ProviderHallProbeKey = append(c.hooks.ProviderHallProbeKey, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `providerhallprobekey.Intercept(f(g(h())))`.
func (c *ProviderHallProbeKeyClient) Intercept(interceptors ...Interceptor) {
	c.inters.ProviderHallProbeKey = append(c.inters.ProviderHallProbeKey, interceptors...)
}

// Create returns a builder for creating a ProviderHallProbeKey entity.
func (c *ProviderHallProbeKeyClient) Create() *ProviderHallProbeKeyCreate {
	mutation := newProviderHallProbeKeyMutation(c.config, OpCreate)
	return &ProviderHallProbeKeyCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of ProviderHallProbeKey entities.
func (c *ProviderHallProbeKeyClient) CreateBulk(builders ...*ProviderHallProbeKeyCreate) *ProviderHallProbeKeyCreateBulk {
	return &ProviderHallProbeKeyCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *ProviderHallProbeKeyClient) MapCreateBulk(slice any, setFunc func(*ProviderHallProbeKeyCreate, int)) *ProviderHallProbeKeyCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ProviderHallProbeKeyCreateBulk{err: fmt.Errorf("calling to ProviderHallProbeKeyClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*ProviderHallProbeKeyCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for ProviderHallProbeKey.
func (c *ProviderHallProbeKeyClient) Update() *ProviderHallProbeKeyUpdate {
	mutation := newProviderHallProbeKeyMutation(c.config, OpUpdate)
	return &ProviderHallProbeKeyUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *ProviderHallProbeKeyClient) UpdateOne(_m *ProviderHallProbeKey) *ProviderHallProbeKeyUpdateOne {
	mutation := newProviderHallProbeKeyMutation(c.config, OpUpdateOne, withProviderHallProbeKey(_m))
	return &ProviderHallProbeKeyUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *ProviderHallProbeKeyClient) UpdateOneID(id int64) *ProviderHallProbeKeyUpdateOne {
	mutation := newProviderHallProbeKeyMutation(c.config, OpUpdateOne, withProviderHallProbeKeyID(id))
	return &ProviderHallProbeKeyUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for ProviderHallProbeKey.
func (c *ProviderHallProbeKeyClient) Delete() *ProviderHallProbeKeyDelete {
	mutation := newProviderHallProbeKeyMutation(c.config, OpDelete)
	return &ProviderHallProbeKeyDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *ProviderHallProbeKeyClient) DeleteOne(_m *ProviderHallProbeKey) *ProviderHallProbeKeyDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *ProviderHallProbeKeyClient) DeleteOneID(id int64) *ProviderHallProbeKeyDeleteOne {
	builder := c.Delete().Where(providerhallprobekey.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ProviderHallProbeKeyDeleteOne{builder}
}

// Query returns a query builder for ProviderHallProbeKey.
func (c *ProviderHallProbeKeyClient) Query() *ProviderHallProbeKeyQuery {
	return &ProviderHallProbeKeyQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeProviderHallProbeKey},
		inters: c.Interceptors(),
	}
}

// Get returns a ProviderHallProbeKey entity by its id.
func (c *ProviderHallProbeKeyClient) Get(ctx context.Context, id int64) (*ProviderHallProbeKey, error) {
	return c.Query().Where(providerhallprobekey.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ProviderHallProbeKeyClient) GetX(ctx context.Context, id int64) *ProviderHallProbeKey {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *ProviderHallProbeKeyClient) Hooks() []Hook {
	return c.hooks.ProviderHallProbeKey
}

// Interceptors returns the client interceptors.
func (c *ProviderHallProbeKeyClient) Interceptors() []Interceptor {
	return c.inters.ProviderHallProbeKey
}

func (c *ProviderHallProbeKeyClient) mutate(ctx context.Context, m *ProviderHallProbeKeyMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ProviderHallProbeKeyCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&ProviderHallProbeKeyUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&ProviderHallProbeKeyUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ProviderHallProbeKeyDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown ProviderHallProbeKey mutation op: %q", m.Op())
	}
}

// ProviderHallProfileClient is a client for the ProviderHallProfile schema.
type ProviderHallProfileClient struct {
	config
}

// NewProviderHallProfileClient returns a client for the ProviderHallProfile from the given config.
func NewProviderHallProfileClient(c config) *ProviderHallProfileClient {
	return &ProviderHallProfileClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `providerhallprofile.Hooks(f(g(h())))`.
func (c *ProviderHallProfileClient) Use(hooks ...Hook) {
	c.hooks.ProviderHallProfile = append(c.hooks.ProviderHallProfile, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `providerhallprofile.Intercept(f(g(h())))`.
func (c *ProviderHallProfileClient) Intercept(interceptors ...Interceptor) {
	c.inters.ProviderHallProfile = append(c.inters.ProviderHallProfile, interceptors...)
}

// Create returns a builder for creating a ProviderHallProfile entity.
func (c *ProviderHallProfileClient) Create() *ProviderHallProfileCreate {
	mutation := newProviderHallProfileMutation(c.config, OpCreate)
	return &ProviderHallProfileCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of ProviderHallProfile entities.
func (c *ProviderHallProfileClient) CreateBulk(builders ...*ProviderHallProfileCreate) *ProviderHallProfileCreateBulk {
	return &ProviderHallProfileCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *ProviderHallProfileClient) MapCreateBulk(slice any, setFunc func(*ProviderHallProfileCreate, int)) *ProviderHallProfileCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ProviderHallProfileCreateBulk{err: fmt.Errorf("calling to ProviderHallProfileClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*ProviderHallProfileCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for ProviderHallProfile.
func (c *ProviderHallProfileClient) Update() *ProviderHallProfileUpdate {
	mutation := newProviderHallProfileMutation(c.config, OpUpdate)
	return &ProviderHallProfileUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *ProviderHallProfileClient) UpdateOne(_m *ProviderHallProfile) *ProviderHallProfileUpdateOne {
	mutation := newProviderHallProfileMutation(c.config, OpUpdateOne, withProviderHallProfile(_m))
	return &ProviderHallProfileUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *ProviderHallProfileClient) UpdateOneID(id int64) *ProviderHallProfileUpdateOne {
	mutation := newProviderHallProfileMutation(c.config, OpUpdateOne, withProviderHallProfileID(id))
	return &ProviderHallProfileUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for ProviderHallProfile.
func (c *ProviderHallProfileClient) Delete() *ProviderHallProfileDelete {
	mutation := newProviderHallProfileMutation(c.config, OpDelete)
	return &ProviderHallProfileDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *ProviderHallProfileClient) DeleteOne(_m *ProviderHallProfile) *ProviderHallProfileDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *ProviderHallProfileClient) DeleteOneID(id int64) *ProviderHallProfileDeleteOne {
	builder := c.Delete().Where(providerhallprofile.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ProviderHallProfileDeleteOne{builder}
}

// Query returns a query builder for ProviderHallProfile.
func (c *ProviderHallProfileClient) Query() *ProviderHallProfileQuery {
	return &ProviderHallProfileQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeProviderHallProfile},
		inters: c.Interceptors(),
	}
}

// Get returns a ProviderHallProfile entity by its id.
func (c *ProviderHallProfileClient) Get(ctx context.Context, id int64) (*ProviderHallProfile, error) {
	return c.Query().Where(providerhallprofile.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ProviderHallProfileClient) GetX(ctx context.Context, id int64) *ProviderHallProfile {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *ProviderHallProfileClient) Hooks() []Hook {
	return c.hooks.ProviderHallProfile
}

// Interceptors returns the client interceptors.
func (c *ProviderHallProfileClient) Interceptors() []Interceptor {
	return c.inters.ProviderHallProfile
}

func (c *ProviderHallProfileClient) mutate(ctx context.Context, m *ProviderHallProfileMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ProviderHallProfileCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&ProviderHallProfileUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&ProviderHallProfileUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ProviderHallProfileDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown ProviderHallProfile mutation op: %q", m.Op())
	}
}

// ProviderHallTargetClient is a client for the ProviderHallTarget schema.
type ProviderHallTargetClient struct {
	config
}

// NewProviderHallTargetClient returns a client for the ProviderHallTarget from the given config.
func NewProviderHallTargetClient(c config) *ProviderHallTargetClient {
	return &ProviderHallTargetClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `providerhalltarget.Hooks(f(g(h())))`.
func (c *ProviderHallTargetClient) Use(hooks ...Hook) {
	c.hooks.ProviderHallTarget = append(c.hooks.ProviderHallTarget, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `providerhalltarget.Intercept(f(g(h())))`.
func (c *ProviderHallTargetClient) Intercept(interceptors ...Interceptor) {
	c.inters.ProviderHallTarget = append(c.inters.ProviderHallTarget, interceptors...)
}

// Create returns a builder for creating a ProviderHallTarget entity.
func (c *ProviderHallTargetClient) Create() *ProviderHallTargetCreate {
	mutation := newProviderHallTargetMutation(c.config, OpCreate)
	return &ProviderHallTargetCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of ProviderHallTarget entities.
func (c *ProviderHallTargetClient) CreateBulk(builders ...*ProviderHallTargetCreate) *ProviderHallTargetCreateBulk {
	return &ProviderHallTargetCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *ProviderHallTargetClient) MapCreateBulk(slice any, setFunc func(*ProviderHallTargetCreate, int)) *ProviderHallTargetCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &ProviderHallTargetCreateBulk{err: fmt.Errorf("calling to ProviderHallTargetClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*ProviderHallTargetCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// Update returns an update builder for ProviderHallTarget.
func (c *ProviderHallTargetClient) Update() *ProviderHallTargetUpdate {
	mutation := newProviderHallTargetMutation(c.config, OpUpdate)
	return &ProviderHallTargetUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *ProviderHallTargetClient) UpdateOne(_m *ProviderHallTarget) *ProviderHallTargetUpdateOne {
	mutation := newProviderHallTargetMutation(c.config, OpUpdateOne, withProviderHallTarget(_m))
	return &ProviderHallTargetUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *ProviderHallTargetClient) UpdateOneID(id int64) *ProviderHallTargetUpdateOne {
	mutation := newProviderHallTargetMutation(c.config, OpUpdateOne, withProviderHallTargetID(id))
	return &ProviderHallTargetUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for ProviderHallTarget.
func (c *ProviderHallTargetClient) Delete() *ProviderHallTargetDelete {
	mutation := newProviderHallTargetMutation(c.config, OpDelete)
	return &ProviderHallTargetDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *ProviderHallTargetClient) DeleteOne(_m *ProviderHallTarget) *ProviderHallTargetDeleteOne {
	return c.DeleteOneID(_m.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *ProviderHallTargetClient) DeleteOneID(id int64) *ProviderHallTargetDeleteOne {
	builder := c.Delete().Where(providerhalltarget.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &ProviderHallTargetDeleteOne{builder}
}

// Query returns a query builder for ProviderHallTarget.
func (c *ProviderHallTargetClient) Query() *ProviderHallTargetQuery {
	return &ProviderHallTargetQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeProviderHallTarget},
		inters: c.Interceptors(),
	}
}

// Get returns a ProviderHallTarget entity by its id.
func (c *ProviderHallTargetClient) Get(ctx context.Context, id int64) (*ProviderHallTarget, error) {
	return c.Query().Where(providerhalltarget.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ProviderHallTargetClient) GetX(ctx context.Context, id int64) *ProviderHallTarget {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *ProviderHallTargetClient) Hooks() []Hook {
	return c.hooks.ProviderHallTarget
}

// Interceptors returns the client interceptors.
func (c *ProviderHallTargetClient) Interceptors() []Interceptor {
	return c.inters.ProviderHallTarget
}

func (c *ProviderHallTargetClient) mutate(ctx context.Context, m *ProviderHallTargetMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&ProviderHallTargetCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&ProviderHallTargetUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&ProviderHallTargetUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&ProviderHallTargetDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown ProviderHallTarget mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		...
		PromoCodeUsage, ProviderHallConfig, ProviderHallGroup, ProviderHallProbeKey,
		ProviderHallProfile, ProviderHallTarget, Proxy, RedeemCode, SecuritySecret,
