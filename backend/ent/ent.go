...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			providerhallconfig.Table:            providerhallconfig.ValidColumn,
			providerhallgroup.Table:             providerhallgroup.ValidColumn,
			providerhallprobekey.Table:          providerhallprobekey.ValidColumn,
			providerhallprofile.Table:           providerhallprofile.ValidColumn,
			providerhalltarget.Table:            providerhalltarget.ValidColumn,
