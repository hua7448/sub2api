...
func init() {
	...
	providerhallconfigFields := schema.ProviderHallConfig{}.Fields()
	_ = providerhallconfigFields
	// providerhallconfigDescCollectionEnabled is the schema descriptor for collection_enabled field.
	providerhallconfigDescCollectionEnabled := providerhallconfigFields[1].Descriptor()
	// providerhallconfig.DefaultCollectionEnabled holds the default value on creation for the collection_enabled field.
	providerhallconfig.DefaultCollectionEnabled = providerhallconfigDescCollectionEnabled.Default.(bool)
	// providerhallconfigDescDisplayEnabled is the schema descriptor for display_enabled field.
	providerhallconfigDescDisplayEnabled := providerhallconfigFields[2].Descriptor()
	// providerhallconfig.DefaultDisplayEnabled holds the default value on creation for the display_enabled field.
	providerhallconfig.DefaultDisplayEnabled = providerhallconfigDescDisplayEnabled.Default.(bool)
	// providerhallconfigDescTasksEnabled is the schema descriptor for tasks_enabled field.
	...
	providerhallconfig.UpdateDefaultUpdatedAt = providerhallconfigDescUpdatedAt.UpdateDefault.(func() time.Time)
	// providerhallconfigDescID is the schema descriptor for id field.
	providerhallconfigDescID := providerhallconfigFields[0].Descriptor()
	// providerhallconfig.DefaultID holds the default value on creation for the id field.
	providerhallconfig.DefaultID = providerhallconfigDescID.Default.(int64)
	providerhallgroupFields := schema.ProviderHallGroup{}.Fields()
	_ = providerhallgroupFields
	// providerhallgroupDescListed is the schema descriptor for listed field.
	providerhallgroupDescListed := providerhallgroupFields[1].Descriptor()
	// providerhallgroup.DefaultListed holds the default value on creation for the listed field.
	providerhallgroup.DefaultListed = providerhallgroupDescListed.Default.(bool)
	// providerhallgroupDescDisplayName is the schema descriptor for display_name field.
	providerhallgroupDescDisplayName := providerhallgroupFields[2].Descriptor()
	// providerhallgroup.DefaultDisplayName holds the default value on creation for the display_name field.
	providerhallgroup.DefaultDisplayName = providerhallgroupDescDisplayName.Default.(string)
	// providerhallgroup.DisplayNameValidator is a validator for the "display_name" field. It is called by the builders before save.
	providerhallgroup.DisplayNameValidator = providerhallgroupDescDisplayName.Validators[0].(func(string) error)
	// providerhallgroupDescDescription is the schema descriptor for description field.
	providerhallgroupDescDescription := providerhallgroupFields[3].Descriptor()
	// providerhallgroup.DefaultDescription holds the default value on creation for the description field.
	providerhallgroup.DefaultDescription = providerhallgroupDescDescription.Default.(string)
	// providerhallgroup.DescriptionValidator is a validator for the "description" field. It is called by the builders before save.
	providerhallgroup.DescriptionValidator = providerhallgroupDescDescription.Validators[0].(func(string) error)
	// providerhallgroupDescDisplayOrder is the schema descriptor for display_order field.
	providerhallgroupDescDisplayOrder := providerhallgroupFields[4].Descriptor()
	// providerhallgroup.DefaultDisplayOrder holds the default value on creation for the display_order field.
	providerhallgroup.DefaultDisplayOrder = providerhallgroupDescDisplayOrder.Default.(int)
	// providerhallgroupDescVersion is the schema descriptor for version field.
	providerhallgroupDescVersion := providerhallgroupFields[5].Descriptor()
	// providerhallgroup.DefaultVersion holds the default value on creation for the version field.
	providerhallgroup.DefaultVersion = providerhallgroupDescVersion.Default.(int64)
	// providerhallgroup.VersionValidator is a validator for the "version" field. It is called by the builders before save.
	providerhallgroup.VersionValidator = providerhallgroupDescVersion.Validators[0].(func(int64) error)
	// providerhallgroupDescUpdatedAt is the schema descriptor for updated_at field.
	providerhallgroupDescUpdatedAt := providerhallgroupFields[7].Descriptor()
	// providerhallgroup.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	providerhallgroup.DefaultUpdatedAt = providerhallgroupDescUpdatedAt.Default.(func() time.Time)
	// providerhallgroup.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	providerhallgroup.UpdateDefaultUpdatedAt = providerhallgroupDescUpdatedAt.UpdateDefault.(func() time.Time)
	providerhallprobekeyFields := schema.ProviderHallProbeKey{}.Fields()
	_ = providerhallprobekeyFields
	// providerhallprobekeyDescOperatorUserID is the schema descriptor for operator_user_id field.
	providerhallprobekeyDescOperatorUserID := providerhallprobekeyFields[1].Descriptor()
	// providerhallprobekey.OperatorUserIDValidator is a validator for the "operator_user_id" field. It is called by the builders before save.
	providerhallprobekey.OperatorUserIDValidator = providerhallprobekeyDescOperatorUserID.Validators[0].(func(int64) error)
	// providerhallprobekeyDescGroupID is the schema descriptor for group_id field.
	providerhallprobekeyDescGroupID := providerhallprobekeyFields[2].Descriptor()
	// providerhallprobekey.GroupIDValidator is a validator for the "group_id" field. It is called by the builders before save.
	providerhallprobekey.GroupIDValidator = providerhallprobekeyDescGroupID.Validators[0].(func(int64) error)
	// providerhallprobekeyDescRegisteredBy is the schema descriptor for registered_by field.
	providerhallprobekeyDescRegisteredBy := providerhallprobekeyFields[3].Descriptor()
	// providerhallprobekey.RegisteredByValidator is a validator for the "registered_by" field. It is called by the builders before save.
	providerhallprobekey.RegisteredByValidator = providerhallprobekeyDescRegisteredBy.Validators[0].(func(int64) error)
	// providerhallprobekeyDescRegisteredAt is the schema descriptor for registered_at field.
	providerhallprobekeyDescRegisteredAt := providerhallprobekeyFields[4].Descriptor()
	// providerhallprobekey.DefaultRegisteredAt holds the default value on creation for the registered_at field.
	providerhallprobekey.DefaultRegisteredAt = providerhallprobekeyDescRegisteredAt.Default.(func() time.Time)
	providerhallprofileFields := schema.ProviderHallProfile{}.Fields()
	_ = providerhallprofileFields
	// providerhallprofileDescModel is the schema descriptor for model field.
	providerhallprofileDescModel := providerhallprofileFields[0].Descriptor()
	// providerhallprofile.ModelValidator is a validator for the "model" field. It is called by the builders before save.
	providerhallprofile.ModelValidator = func() func(string) error {
		validators := providerhallprofileDescModel.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// providerhallprofileDescSupportsTools is the schema descriptor for supports_tools field.
	providerhallprofileDescSupportsTools := providerhallprofileFields[2].Descriptor()
	// providerhallprofile.DefaultSupportsTools holds the default value on creation for the supports_tools field.
	providerhallprofile.DefaultSupportsTools = providerhallprofileDescSupportsTools.Default.(bool)
	// providerhallprofileDescOutputLimit is the schema descriptor for output_limit field.
	providerhallprofileDescOutputLimit := providerhallprofileFields[3].Descriptor()
	// providerhallprofile.DefaultOutputLimit holds the default value on creation for the output_limit field.
	providerhallprofile.DefaultOutputLimit = providerhallprofileDescOutputLimit.Default.(int)
	// providerhallprofile.OutputLimitValidator is a validator for the "output_limit" field. It is called by the builders before save.
	providerhallprofile.OutputLimitValidator = func() func(int) error {
		validators := providerhallprofileDescOutputLimit.Validators
		fns := [...]func(int) error{
			validators[0].(func(int) error),
			validators[1].(func(int) error),
		}
		return func(output_limit int) error {
			for _, fn := range fns {
				if err := fn(output_limit); err != nil {
					return err
				}
			}
			return nil
	...
	// providerhallprofileDescModelAliases is the schema descriptor for model_aliases field.
	providerhallprofileDescModelAliases := providerhallprofileFields[4].Descriptor()
	// providerhallprofile.DefaultModelAliases holds the default value on creation for the model_aliases field.
	providerhallprofile.DefaultModelAliases = providerhallprofileDescModelAliases.Default.([]string)
	// providerhallprofileDescVersion is the schema descriptor for version field.
	providerhallprofileDescVersion := providerhallprofileFields[9].Descriptor()
	// providerhallprofile.DefaultVersion holds the default value on creation for the version field.
	providerhallprofile.DefaultVersion = providerhallprofileDescVersion.Default.(int64)
	// providerhallprofile.VersionValidator is a validator for the "version" field. It is called by the builders before save.
	providerhallprofile.VersionValidator = providerhallprofileDescVersion.Validators[0].(func(int64) error)
	// providerhallprofileDescUpdatedAt is the schema descriptor for updated_at field.
	providerhallprofileDescUpdatedAt := providerhallprofileFields[11].Descriptor()
	// providerhallprofile.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	providerhallprofile.DefaultUpdatedAt = providerhallprofileDescUpdatedAt.Default.(func() time.Time)
	// providerhallprofile.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	providerhallprofile.UpdateDefaultUpdatedAt = providerhallprofileDescUpdatedAt.UpdateDefault.(func() time.Time)
	providerhalltargetFields := schema.ProviderHallTarget{}.Fields()
	_ = providerhalltargetFields
	// providerhalltargetDescGroupID is the schema descriptor for group_id field.
	providerhalltargetDescGroupID := providerhalltargetFields[0].Descriptor()
	// providerhalltarget.GroupIDValidator is a validator for the "group_id" field. It is called by the builders before save.
	providerhalltarget.GroupIDValidator = providerhalltargetDescGroupID.Validators[0].(func(int64) error)
	// providerhalltargetDescProfileID is the schema descriptor for profile_id field.
	providerhalltargetDescProfileID := providerhalltargetFields[1].Descriptor()
	// providerhalltarget.ProfileIDValidator is a validator for the "profile_id" field. It is called by the builders before save.
	providerhalltarget.ProfileIDValidator = providerhalltargetDescProfileID.Validators[0].(func(int64) error)
	// providerhalltargetDescProbeKeyID is the schema descriptor for probe_key_id field.
	providerhalltargetDescProbeKeyID := providerhalltargetFields[2].Descriptor()
	// providerhalltarget.ProbeKeyIDValidator is a validator for the "probe_key_id" field. It is called by the builders before save.
	providerhalltarget.ProbeKeyIDValidator = providerhalltargetDescProbeKeyID.Validators[0].(func(int64) error)
	// providerhalltargetDescEnabled is the schema descriptor for enabled field.
	...
	providerhalltarget.ProbeIntervalSecondsValidator = func() func(int) error {
		validators := providerhalltargetDescProbeIntervalSeconds.Validators
		fns := [...]func(int) error{
			validators[0].(func(int) error),
			validators[1].(func(int) error),
		}
		return func(probe_interval_seconds int) error {
			for _, fn := range fns {
				if err := fn(probe_interval_seconds); err != nil {
					return err
				}
			}
			return nil
	...
	providerhalltarget.VerificationIntervalSecondsValidator = func() func(int) error {
		validators := providerhalltargetDescVerificationIntervalSeconds.Validators
		fns := [...]func(int) error{
			validators[0].(func(int) error),
			validators[1].(func(int) error),
		}
		return func(verification_interval_seconds int) error {
			for _, fn := range fns {
				if err := fn(verification_interval_seconds); err != nil {
					return err
				}
			}
			return nil
	...
	providerhalltarget.UpdateDefaultUpdatedAt = providerhalltargetDescUpdatedAt.UpdateDefault.(func() time.Time)
