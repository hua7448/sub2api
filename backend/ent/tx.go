...
func (tx *Tx) init() {
	...
	tx.ProviderHallConfig = NewProviderHallConfigClient(tx.config)
	tx.ProviderHallGroup = NewProviderHallGroupClient(tx.config)
	tx.ProviderHallProbeKey = NewProviderHallProbeKeyClient(tx.config)
	tx.ProviderHallProfile = NewProviderHallProfileClient(tx.config)
	tx.ProviderHallTarget = NewProviderHallTargetClient(tx.config)
