<template>
  <AppLayout>
    <div class="space-y-6">
        ...
        <div class="card p-4">
          <div class="flex flex-wrap items-center gap-4">
            <div class="flex items-center gap-2">
              <span class="text-sm font-medium text-txt-primary">{{ t('admin.dashboard.timeRange') }}:</span>
              <DateRangePicker
            ...
            <div class="ml-auto flex items-center gap-2">
              <span class="text-sm font-medium text-txt-primary">{{ t('admin.dashboard.granularity') }}:</span>
              <div class="w-28">
      ...
      <div class="card">
        <div class="flex flex-wrap items-center border-b border-cyber-border px-2 sm:px-4">
          <button
            ...
            :class="activeTab === tab.key
              ? 'border-primary-500 text-neon-cyan'
              : 'border-transparent text-txt-secondary hover:border-cyber-border hover:text-txt-primary'"
        ...
        <UsageFilters v-model="filters" ref="usageFiltersRef" flat :mode="activeTab" class="border-b border-cyber-border/50" :start-date="startDate" :end-date="endDate" :exporting="exporting" :model-options="modelNameOptions" @change="applyFilters" @refresh="refreshData" @reset="resetFilters" @cleanup="openCleanupDialog" @export="exportToExcel">
            ...
            <div v-if="activeTab !== 'ranking'" class="relative" ref="columnDropdownRef">
              ...
              >
                <button
                  ...
                  class="flex w-full items-center justify-between px-4 py-2 text-left text-sm text-txt-primary hover:bg-cyber-elevated"
                >
                  <span>{{ col.label }}</span>
                  <Icon
