  ...
  <AppLayout>
    <TablePageLayout>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-user_concurrency_limit="{ value }">
            <span
              v-if="value && value > 0"
              class="text-sm text-gray-700 dark:text-gray-300"
            >
              {{ value }} {{ t("admin.groups.userConcurrencyUnit") }}
            </span>
            <span v-else class="text-sm text-gray-400 dark:text-gray-500">
              {{ t("admin.groups.userConcurrencyFallback") }}
            </span>
          </template>
    ...
    >
      ...
      >
        ...
        <div>
          <label class="input-label">{{
            t("admin.groups.form.userConcurrencyLimit")
          }}</label>
          <input
            ...
            class="input"
            :placeholder="
              t('admin.groups.form.userConcurrencyLimitPlaceholder')
            "
          />
          <p class="input-hint">
            {{ t("admin.groups.form.userConcurrencyLimitHint") }}
          </p>
        </div>
        <div>
...
const allColumns = computed<Column[]>(() => [
  ...
  {
    key: "user_concurrency_limit",
    label: t("admin.groups.columns.userConcurrencyLimit"),
    sortable: true,
  },
  {
    key: "is_exclusive",
...
const createForm = reactive({
  ...
  rate_multiplier: 1.0,
  user_concurrency_limit: null as number | string | null,
  is_exclusive: false,
...
const closeCreateModal = () => {
  ...
  createForm.user_concurrency_limit = null;
...
const handleCreateGroup = async () => {
  ...
  try {
    ...
    const requestData = {
      ...createGroupForm,
      user_concurrency_limit: normalizeOptionalPositiveInt(
...
const handleEdit = async (group: AdminGroup) => {
  ...
  editForm.user_concurrency_limit = group.user_concurrency_limit ?? null;
