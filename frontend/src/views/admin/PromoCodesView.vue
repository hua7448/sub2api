<template>
  <AppLayout>
        ...
        >
          <template #cell-code="{ value }">
            <div class="flex items-center space-x-2">
              <code class="font-mono text-sm text-txt-primary">{{ value }}</code>
              <button
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center space-x-1">
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-txt-secondary transition-colors hover:bg-neon-green/10 hover:text-neon-green hover:bg-green-900/20 hover:text-green-400"
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-txt-secondary transition-colors hover:bg-cyber-elevated hover:text-txt-primary hover:text-txt-dim"
                :title="t('common.edit')"
              >
      ...
      <form id="create-promo-form" @submit.prevent="handleCreate" class="space-y-4">
        <div>
          <label class="input-label">
            {{ t('admin.promo.code') }}
            <span class="ml-1 text-xs font-normal text-txt-dim">({{ t('admin.promo.autoGenerate') }})</span>
          </label>
          <input
        ...
        <div>
          <label class="input-label">
            ...
            <span class="ml-1 text-xs font-normal text-txt-dim">({{ t('admin.promo.zeroUnlimited') }})</span>
          </label>
          <input
        ...
        <div>
          <label class="input-label">
            ...
            <span class="ml-1 text-xs font-normal text-txt-dim">({{ t('common.optional') }})</span>
          </label>
          <input
    ...
    >
      ...
      <div v-else-if="usages.length === 0" class="py-8 text-center text-txt-secondary">
      ...
      <div v-else class="space-y-3">
        <div
          ...
          :key="usage.id"
          class="flex items-center justify-between rounded-lg border border-cyber-border p-3"
        >
          <div class="flex items-center gap-3">
            <div class="flex h-8 w-8 items-center justify-center rounded-full bg-green-100 bg-green-900/30">
              <Icon name="user" size="sm" class="text-neon-green text-green-400" />
            </div>
            <div>
          ...
          <div class="text-right">
            <span class="text-sm font-medium text-neon-green text-green-400">
