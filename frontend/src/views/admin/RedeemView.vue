  ...
  <AppLayout>
        ...
        >
          ...
          <template #cell-value="{ value, row }">
            <span class="text-sm font-medium text-txt-primary">
              ...
              <template v-else-if="row.type === 'subscription'">
                ...
                <span v-if="row.group" class="ml-1 text-xs text-txt-secondary"
                  >({{ row.group.name }})</span
                >
              </template>
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center space-x-2">
              ...
              <span v-else class="text-txt-dim">-</span>
            </div>
          </template>
        </DataTable>
      </template>
    ...
    <Teleport to="body">
      <div v-if="showGenerateDialog" class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div
          class="relative z-10 w-full max-w-md rounded-xl bg-cyber-surface p-6 shadow-xl"
        >
          <h2 class="mb-4 text-lg font-semibold text-txt-primary">
          ...
          <form @submit.prevent="handleGenerateCodes" class="space-y-4">
            ...
            <!-- 邀请码类型：显示提示信息 -->
            <div v-if="generateForm.type === 'invitation'" class="rounded-lg bg-blue-50 p-3 bg-blue-900/20">
              ...
              <div>
                ...
                >
                  <template #selected="{ option }">
                    ...
                    />
                    <span v-else class="text-txt-dim">{{
    ...
    <Teleport to="body">
      <div v-if="showResultDialog" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative z-10 w-full max-w-lg rounded-xl bg-cyber-surface shadow-xl">
          <!-- Header -->
          <div
            class="flex items-center justify-between border-b border-cyber-border px-5 py-4"
          >
            <div class="flex items-center gap-3">
              <div
                class="flex h-10 w-10 items-center justify-center rounded-full bg-green-100 bg-green-900/30"
              >
                <svg
                  class="h-5 w-5 text-neon-green text-green-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div>
                <h2 class="text-base font-semibold text-txt-primary">
            ...
            <button
              ...
              class="rounded-lg p-1.5 text-txt-dim transition-colors hover:bg-cyber-elevated hover:text-txt-secondary hover:text-txt-dim"
            >
          ...
          <div class="p-5">
            <div class="relative">
              <textarea
                ...
                class="w-full resize-none rounded-lg border border-cyber-border bg-cyber-bg p-3 font-mono text-sm text-txt-primary focus:outline-none"
              ></textarea>
            </div>
          </div>
          <!-- Footer -->
          <div
            class="flex justify-end gap-2 rounded-b-xl border-t border-cyber-border bg-cyber-bg px-5 py-4"
          >
            <button
