<template>
  <component :is="isFullscreen ? 'div' : AppLayout" :class="isFullscreen ? 'flex min-h-screen flex-col justify-center bg-cyber-bg' : ''">
    <div :class="[isFullscreen ? 'p-4 md:p-6' : '', 'space-y-6 pb-12']">
      <div
        v-if="errorMessage"
        class="rounded-2xl bg-neon-pink/10 p-4 text-sm text-neon-pink bg-red-900/20 text-red-400"
      >
        {{ errorMessage }}
      </div>
