...
<template>
  <section class="card p-4 md:p-5">
    <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
      <h3 class="text-sm font-bold text-txt-primary">
    ...
    <div v-if="errorMessage" class="mb-4 rounded-lg bg-neon-pink/10 px-3 py-2 text-xs text-neon-pink bg-red-900/20 text-red-400">
      {{ errorMessage }}
    </div>

    <div v-if="loading" class="py-8 text-center text-sm text-txt-secondary">
    ...
    <div v-else class="space-y-3">
      <div class="overflow-hidden rounded-xl border border-cyber-border">
        <div class="max-h-[420px] overflow-auto">
          ...
          <table v-else class="min-w-full text-left text-xs md:text-sm">
            <thead class="sticky top-0 z-10 bg-cyber-surface">
              <tr class="border-b border-cyber-border text-txt-secondary">
            ...
            <tbody>
              <tr
                v-for="row in items"
                :key="row.model"
                class="border-b border-gray-100 text-txt-primary last:border-b-0"
              >
      ...
      <div v-if="viewMode === 'topn'" class="mt-3 text-xs text-txt-secondary">
