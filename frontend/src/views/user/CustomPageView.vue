    ...
    <div class="custom-page-layout">
      <div class="card flex-1 min-h-0 overflow-hidden">
        ...
        >
          <div class="max-w-md">
            <div
              class="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-cyber-elevated"
            >
              <Icon name="link" size="lg" class="text-txt-dim" />
            </div>
...
.custom-embed-shell {
  ...
  @apply bg-gradient-to-b from-gray-50 to-white from-dark-900 to-dark-950;
  @apply p-0;
}

.custom-open-fab {
  @apply absolute right-3 top-3 z-10;
  @apply shadow-sm backdrop-blur supports-[backdrop-filter]:bg-cyber-surface/80;
}
