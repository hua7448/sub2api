<template>
  <div
    class="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 p-4 from-dark-900 to-dark-800"
  >
    <div class="w-full max-w-2xl">
      ...
      <div class="mb-8 text-center">
        ...
        <h1 class="text-3xl font-bold text-txt-primary">{{ t('setup.title') }}</h1>
        <p class="mt-2 text-txt-secondary">{{ t('setup.description') }}</p>
      </div>
        ...
        <div class="flex items-center justify-center">
          <template v-for="(step, index) in steps" :key="step.id">
              ...
              <div
                :class="[
                  ...
                  currentStep > index
                    ? 'bg-neon-cyan/100'
                    : currentStep === index
                      ? 'bg-neon-cyan/100 ring-4 ring-primary-100 ring-primary-900'
            ...
            <div
              ...
              :class="currentStep > index ? 'bg-neon-cyan/100' : 'bg-gray-200 dark:bg-dark-700'"
            ></div>
          </template>
        </div>
      </div>
      ...
      <!-- Step Content -->
      <div class="rounded-2xl bg-cyber-surface p-8 shadow-xl">
        <!-- Step 1: Database -->
        <div v-if="currentStep === 0" class="space-y-6">
          ...
          <div class="flex items-center justify-between rounded-xl border border-cyber-border p-3">
            <div>
          ...
          >
            ...
            <Icon v-else-if="dbConnected" name="check" size="md" class="mr-2 text-neon-green" :stroke-width="2" />
            {{
              testingDb
        ...
        <div v-if="currentStep === 3" class="space-y-6">
          ...
          <div class="space-y-4">
            <div class="rounded-xl bg-cyber-bg p-4">
              <h3 class="mb-2 text-sm font-medium text-txt-secondary">
            ...
            <div class="rounded-xl bg-cyber-bg p-4">
              ...
              <p class="text-txt-primary">{{ formData.admin.email }}</p>
            </div>
          </div>
        </div>
        ...
        <div
          v-if="errorMessage"
          class="mt-6 rounded-xl border border-red-200 bg-neon-pink/10 p-4 border-red-800/50 bg-red-900/20"
        >
          <div class="flex items-start gap-3">
            <Icon name="exclamationCircle" size="md" class="flex-shrink-0 text-neon-pink" />
            <p class="text-sm text-red-700 text-red-400">{{ errorMessage }}</p>
          </div>
        </div>
        ...
        <div
          v-if="installSuccess"
          class="mt-6 rounded-xl border border-green-200 bg-neon-green/10 p-4 border-green-800/50 bg-green-900/20"
        >
          <div class="flex items-start gap-3">
            <svg
              v-if="!serviceReady"
              class="h-5 w-5 flex-shrink-0 animate-spin text-neon-green"
              fill="none"
              viewBox="0 0 24 24"
            >
              <circle
            ...
            <Icon v-else name="checkCircle" size="md" class="flex-shrink-0 text-neon-green" />
            <div>
              <p class="text-sm font-medium text-green-700 text-green-400">
                {{ t('setup.status.completed') }}
              </p>
              <p class="mt-1 text-sm text-neon-green text-neon-green">
                {{
                  serviceReady
