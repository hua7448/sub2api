export default {
  ...
  leaderboard: {
    ...
    gapNext: '再{action} {amount} 超越 #{rank} {email}',
    gapTop3: '再{action} {amount} 冲进前三！',
    gapInBoard: '你在{board}排#{rank}，再{action} {amount} 可超越上一名',
    leading: '你领先第2名 {amount}，继续保持！',
    gapCost: '消费',
    gapRecharge: '充值',
    gapTokens: '使用',
    gapRequests: '请求',
    ...
    ctaTitle: '想上榜？立即登录参与排名！',
    ctaDesc: '看看你能排第几，和大佬们一较高下',
    ctaButton: '立即登录',
  },
