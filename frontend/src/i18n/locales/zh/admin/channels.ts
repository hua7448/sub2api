export default {
    ...
    subscriptions: {
      ...
      resetTodayUsage: '重置今日额度',
      resettingTodayUsage: '重置中...',
      resetTodayUsageTitle: '重置所有订阅的今日额度',
      resetTodayUsageConfirm: '确定要重置所有有效订阅按北京时间计算、截至执行时刻的今日用量吗？系统会清除这部分日用量，并从周用量和月用量各减去同一金额；日、周、月窗口起点保持不变。执行后的新用量会继续正常累计。',
      resetTodayUsageSuccess: '已重置 {subscriptions} 个有效订阅，周/月用量各扣减 ${amount}',
      failedToResetTodayUsage: '重置今日订阅额度失败',
