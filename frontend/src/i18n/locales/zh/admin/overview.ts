export default {
    ...
    groups: {
      ...
      accountsTotal: '总量:',
      accountsUnit: '个账号',
      userConcurrencyUnit: '并发',
      userConcurrencyFallback: '回退用户全局并发',
      form: {
        name: '名称',
        description: '描述',
        platform: '平台',
        rateMultiplier: '费率倍数',
        userConcurrencyLimit: '分组用户并发上限',
        userConcurrencyLimitPlaceholder: '留空则回退用户全局并发',
        userConcurrencyLimitHint: '配置后，此分组下的请求会优先使用这里的并发值；留空时才使用用户全局并发。',
        status: '状态',
        exclusive: '专属分组',
        nameLabel: '分组名称',
