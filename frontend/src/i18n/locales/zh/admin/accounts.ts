export default {
    accounts: {
      ...
      enableKeepStatusActive: '保持正常',
      disableKeepStatusActive: '取消保持正常',
      failedToToggleKeepStatusActive: '切换保持正常失败',
      ...
      bulkActions: {
        ...
        edit: '批量编辑账号',
        delete: '批量删除',
        testSelected: '批量测试 GPT-5.5',
        testingSelected: '测试中...',
        testScopeAll: '所有账号',
        testScopeError: '仅失效账号',
        startTest: '开始测试 GPT-5.5',
        testingInvalid: '测试中 {completed}/{total}',
        testAllConfirm: '将使用 {model} 测试全部 {count} 个账号（排除 Pro 和 API Key）。测试通过的账号会恢复正常，失败账号会标记为错误并保留最新错误原因。是否继续？',
        testInvalidConfirm: '将使用 {model} 测试 {count} 个失效账号（排除 Pro 和 API Key）。测试通过的账号会恢复正常，失败账号会保留最新错误原因。是否继续？',
        noInvalidAccounts: '没有需要测试的账号',
        testInvalidDone: '{model} 测试完成：有效 {success} 个，失效 {failed} 个，限流 {rateLimited} 个',
        latestAllTest: '最近一次全量账号测试',
        latestInvalidTest: '最近一次失效账号测试',
        validCount: '有效 {count}',
        invalidCount: '失效 {count}',
        rateLimitedCount: '限流 {count}',
        viewTestDetails: '查看账号明细',
        testConfirm: '确定要用 {model} 测试选中的 {count} 个账号吗？测试失败的账号会被标记为错误。',
        testSuccess: '已用 {model} 成功测试 {count} 个账号',
        testRateLimited: '{model} 批量测试完成：成功 {success} 个，限流中 {rateLimited} 个',
        testPartial: '{model} 批量测试部分完成：成功 {success} 个，限流中 {rateLimited} 个，错误 {failed} 个',
        testFailed: '批量测试账号失败',
        confirmDelete: '确认删除选中的 {count} 个账号吗？此操作不可恢复。',
        deleteSuccess: '已成功删除 {count} 个账号',
        enableScheduling: '批量启用调度',
        disableScheduling: '批量停止调度',
        enableKeepStatusActive: '批量保持正常',
        disableKeepStatusActive: '批量取消保持正常',
        resetStatus: '批量重置状态',
        refreshToken: '批量刷新令牌',
        probeUpstreamBilling: '探测上游倍率',
        resetStatusSuccess: '已成功重置 {count} 个账号状态',
        refreshTokenSuccess: '已成功刷新 {count} 个账号令牌',
        enableKeepStatusActiveSuccess: '已为 {count} 个账号开启保持正常',
        disableKeepStatusActiveSuccess: '已为 {count} 个账号关闭保持正常',
      ...
      proxy: '代理',
      noProxy: '无代理',
      autoAssignProxy: '自动分配有效代理',
      autoAssignProxyHint: '保存账号时会随机挂到一个连通正常的代理；需要指定代理或直连时可关闭。',
      manualProxySelectionHint: '关闭自动分配后，可手动指定代理，或选择“无代理”直连。',
      concurrency: '并发数',
      loadFactor: '负载因子',
