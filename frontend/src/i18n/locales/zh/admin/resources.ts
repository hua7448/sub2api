export default {
    ...
    proxies: {
      ...
      reassignFailedAccounts: '迁移失效代理账号',
      reassignFailedAccountsConfirm: '将把失效代理上的账号随机迁移到有效代理，是否继续？',
      reassignFailedAccountsDone: '已迁移 {accounts} 个账号，涉及 {failed} 个失效代理，可用代理 {healthy} 个',
      reassignFailedAccountsEmpty: '没有需要迁移的失效代理账号',
