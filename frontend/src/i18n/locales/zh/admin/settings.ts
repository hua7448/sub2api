export default {
    settings: {
      ...
      features: {
        ...
        providerHall: {
          title: '供应商大厅',
          description: '面向用户的供应商大厅页面由「渠道管理 > 供应商大厅」中的用户展示开关控制，此处不单独设置；开关打开后侧边栏出现「供应商大厅」入口。',
          configureLink: '前往 渠道管理 > 供应商大厅 配置',
        },
        availableChannels: {
          title: '可用渠道',
        ...
        affiliate: {
          ...
          minQualifiedInvitees: '最低有效邀请人数',
          minQualifiedInviteesDesc: '邀请人至少邀请多少个有效用户（有过充值或订阅）后才能开始累积和提取返利。0 = 无门槛。',
          customUsers: {
            title: '专属用户配置',
      ...
      registration: {
        ...
        blockProviderAliases: '禁止别名邮箱注册',
        blockProviderAliasesHint:
          '拒绝 Gmail 点号和 Googlemail 地址、QQ 非数字账号及 Foxmail 等可识别的等价邮箱；同时应用于新注册和邮箱绑定',
