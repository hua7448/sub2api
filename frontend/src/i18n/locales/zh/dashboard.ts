export default {
  ...
  modelsPage: {
    title: '可用模型',
    description: '按分组查看当前可以调用的模型列表。',
    searchPlaceholder: '搜索分组或模型',
    viewModels: '查看模型',
    collapseModels: '收起',
    expandAll: '全部展开',
    collapseAll: '全部收起',
    searchLoading: '正在补充加载模型列表，以便按模型名搜索。',
    emptyTitle: '暂无可用分组',
    emptyDescription: '当前账号还没有可查看模型的分组。',
    noMatchTitle: '没有匹配结果',
    noMatchDescription: '换个分组名或模型名试试。',
    modelCount: '{count} 个模型',
    defaultTag: '默认列表',
    defaultHint: '当前未检测到该分组账号的自定义模型映射，正在展示分组默认模型列表。',
    noModels: '该分组当前暂无可用模型。',
    failedToLoad: '加载模型列表失败，请稍后重试。'
  },
  ...
  affiliate: {
    title: '邀请返利',
    description: '邀请客户注册，清楚查看兑换码产生的现金和订阅天数返利',
    yourCode: '我的邀请码',
    inviteLink: '邀请链接',
    copyCode: '复制邀请码',
    copyLink: '复制链接',
    ...
    stats: {
      rebateRate: '我的返利比例',
      rebateRateHint: '余额码金额或订阅码天数对应的返利比例',
      invitedUsers: '邀请人数',
      customers: '有效客户 / 总邀请',
      customersHint: '有效客户已实际兑换余额码或订阅码',
      availableQuota: '可转返利额度',
      frozenQuota: '冻结中',
      frozenQuotaHint: '新产生的返利正在冻结期中',
      totalQuota: '历史返利额度',
      totalQuotaHint: '累计获得的现金返利'
    },
    transfer: {
      title: '返利额度转余额',
    ...
    invitees: {
      title: '邀请客户',
      description: '查看邀请关系、兑换资格和已产生的现金返利',
      empty: '暂无邀请记录',
      search: '搜索邮箱或用户名',
      noMatch: '没有匹配的客户',
      qualified: '有效客户',
    ...
    tips: {
      ...
      line2: '客户兑换余额码可获得 {rate} 现金返利，兑换任意订阅码可获得相同比例的订阅天数。',
      line3: '返利额度可随时转入账户余额。',
      line4: '至少邀请 {count} 个有效客户（已兑换），从第 {start} 个客户开始，后续客户兑换都会有返利。',
      line4NoThreshold: '当前未设置有效客户门槛，所有客户兑换都会有返利。',
      line5: '新产生的返利需要经过冻结期后才能提现。'
    },
    threshold: {
      notMet: '还需 {remaining} 位有效客户解锁返利',
      met: '返利资格已解锁',
      progress: '资格进度',
      pendingSummary: '客户实际兑换正数余额码或订阅码后，才会计为有效客户。',
      readySummary: '已满足门槛，从第 {start} 位兑换客户开始产生返利。',
      noThreshold: '当前无有效客户门槛，客户兑换后直接按规则返利。',
      qualifiedCount: '有效客户：{count}/{required}'
    },
    subscriptionDays: {
      title: '订阅天数返利',
      description: '客户兑换任意订阅分组的兑换码后，按比例获得对应分组的订阅天数',
      allTypes: '全部订阅分组',
      empty: '暂无可提取的订阅天数',
      pendingDays: '可提取天数',
      frozenDays: '冻结中',
      transferButton: '提取',
      transferring: '提取中...',
      transferSuccess: '已为您续期 {days} 天（{group}）'
    },
    records: {
      rebateTitle: '返利记录',
      rebateDescription: '余额兑换和所有订阅分组兑换产生的完整返利流水',
      rebateEmpty: '暂无返利记录',
      transferTitle: '提取记录',
      transferDescription: '现金返利转入账户余额的历史流水',
      transferEmpty: '暂无提取记录',
      loadFailed: '加载记录失败',
      columns: {
        source: '返利来源',
        group: '订阅分组',
      ...
      source: {
        balanceRedeem: '余额码兑换',
        subscriptionRedeem: '订阅码兑换',
        balancePayment: '余额支付',
        subscriptionPayment: '订阅支付',
        unknown: '其他来源'
      }
    },
    share: {
      title: '邀请客户',
      description: '分享邀请码或专属链接，新用户注册后自动绑定邀请关系'
    }
  },

  imageStudio: {
    title: 'AI画图',
    description: '从灵感到成图，在一个工作台里完成画图、编辑、重绘与历史管理。',
    loadingKeys: '正在加载可用的 API Key...',
    noKeysTitle: '还没有可用的 API Key',
    noKeysDescription: '请先创建至少一个激活中的 API Key，再进入 AI画图工作台。',
    manageKeys: '前往密钥管理',
    activeKeyHint: '当前已选中 {name}。如果该 Key 所在分组不支持图片模型，请切换其他 Key。',
    frameLoading: '正在加载 AI画图工作台...',
  },
