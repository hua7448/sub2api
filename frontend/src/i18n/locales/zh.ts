export default {
  ...
  admin: {
    ...
    imageGallery: {
      ...
      defaultModel: '默认模型',
      agentModel: 'Agent/Responses 默认模型',
      maxGenerationCount: '最大生成数量',
      allowedModels: '允许模型',
      allowedAgentModels: '允许 Agent/Responses 模型',
      allowedSizes: '允许尺寸',
      allowedQuality: '允许质量',
    ...
    settings: {
      ...
      features: {
        ...
        externalRecharge: {
          title: '外部充值入口',
          description: '在用户侧边栏展示“点我去充值”菜单，点击后在新页签打开配置的充值页面。',
          enabled: '显示点我去充值入口',
          enabledHint: '仅控制外部充值链接入口，不影响内置支付页和订单功能。',
          url: '充值页面链接',
          urlPlaceholder: 'https://example.com/recharge',
          urlHint: '必须是完整的 http(s) 链接；用户点击菜单后会在新页签打开。',
          urlInvalid: '充值页面链接必须是完整的 http(s) 链接',
          urlRequired: '启用外部充值入口时必须填写充值页面链接',
        },
        availableChannels: {
          title: '可用渠道',
