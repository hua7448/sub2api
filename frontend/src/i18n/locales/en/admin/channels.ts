export default {
    ...
    subscriptions: {
      ...
      resetTodayUsage: "Reset Today's Usage",
      resettingTodayUsage: 'Resetting...',
      resetTodayUsageTitle: "Reset Today's Usage for All Subscriptions",
      resetTodayUsageConfirm: "Reset today's usage through the execution cutoff for every active subscription, using China Standard Time? That usage will be cleared from daily usage and deducted from both weekly and monthly usage. Window start times remain unchanged, and new usage after the cutoff continues accumulating normally.",
      resetTodayUsageSuccess: 'Reset {subscriptions} active subscriptions; deducted ${amount} from both weekly and monthly usage',
      failedToResetTodayUsage: "Failed to reset today's subscription usage",
