export default {
    settings: {
      ...
      features: {
        ...
        providerHall: {
          title: 'Provider Hall',
          description: 'The user-facing provider hall page is controlled by the display switch under Channel Management > Provider Hall; there is no separate setting here. Once enabled, the sidebar shows a Provider Hall entry.',
          configureLink: 'Configure in Channel Management > Provider Hall',
        },
        availableChannels: {
        ...
        affiliate: {
          ...
          minQualifiedInvitees: 'Min Qualified Invitees',
          minQualifiedInviteesDesc: 'Minimum number of qualified invitees (who have recharged or subscribed) before the inviter can accrue and withdraw rebates. 0 = no threshold.',
          customUsers: {
      ...
      registration: {
        ...
        blockProviderAliases: 'Block Provider Email Aliases',
        blockProviderAliasesHint:
          'Reject recognizable equivalent addresses such as Gmail dot and Googlemail addresses, non-numeric QQ addresses, and Foxmail aliases during signup and email binding.',
      ...
      customMenu: {
        ...
        openMode: 'Open Mode',
        openModeSite: 'Open in Site',
        openModeNewWindow: 'Open in New Window',
        add: 'Add Menu Item',
        remove: 'Remove',
        moveUp: 'Move Up',
        moveDown: 'Move Down',
