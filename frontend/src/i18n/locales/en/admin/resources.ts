export default {
    ...
    proxies: {
      ...
      reassignFailedAccounts: 'Reassign Failed Proxy Accounts',
      reassignFailedAccountsConfirm: 'Move accounts on failed proxies to healthy proxies at random?',
      reassignFailedAccountsDone: 'Reassigned {accounts} accounts from {failed} failed proxies using {healthy} healthy proxies',
      reassignFailedAccountsEmpty: 'No failed-proxy accounts need reassignment',
