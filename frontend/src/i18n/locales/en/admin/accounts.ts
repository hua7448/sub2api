export default {
    accounts: {
      ...
      enableKeepStatusActive: 'Keep Active',
      disableKeepStatusActive: 'Stop Keeping Active',
      failedToToggleKeepStatusActive: 'Failed to toggle keep-active status',
      ...
      bulkActions: {
        ...
        edit: 'Bulk Edit',
        delete: 'Bulk Delete',
        testSelected: 'Test GPT-5.5',
        testingSelected: 'Testing...',
        testScopeAll: 'All Accounts',
        testScopeError: 'Invalid Only',
        startTest: 'Start GPT-5.5 Test',
        testingInvalid: 'Testing {completed}/{total}',
        testAllConfirm: 'Test all {count} accounts with {model}, excluding Pro and API Key accounts? Passing accounts will be recovered and failures will be marked as errors with the latest reason.',
        testInvalidConfirm: 'Test {count} invalid accounts with {model}, excluding Pro and API Key accounts? Passing accounts will be recovered and failures will keep the latest error reason.',
        noInvalidAccounts: 'No accounts need testing',
        testInvalidDone: '{model} test completed: {success} valid, {failed} invalid, {rateLimited} rate limited',
        latestAllTest: 'Latest full account test',
        latestInvalidTest: 'Latest invalid account test',
        validCount: '{count} valid',
        invalidCount: '{count} invalid',
        rateLimitedCount: '{count} rate limited',
        viewTestDetails: 'View account details',
        testConfirm: 'Test the selected {count} account(s) with {model}? Failed accounts will be marked as error.',
        testSuccess: 'Successfully tested {count} account(s) with {model}',
        testRateLimited: '{model} batch test completed: {success} succeeded, {rateLimited} rate limited',
        testPartial: '{model} batch test partially completed: {success} succeeded, {rateLimited} rate limited, {failed} errored',
        testFailed: 'Failed to batch test accounts',
        ...
        enableKeepStatusActiveSuccess: 'Keep Active enabled for {count} account(s)',
        disableKeepStatusActiveSuccess: 'Keep Active disabled for {count} account(s)',
      ...
      proxy: 'Proxy',
      noProxy: 'No Proxy',
      autoAssignProxy: 'Auto-assign healthy proxy',
      autoAssignProxyHint: 'When the account is saved, it will be attached to a randomly selected healthy proxy. Turn this off to choose a proxy or go direct.',
      manualProxySelectionHint: 'With auto-assign off, you can pick a specific proxy or choose No Proxy for a direct connection.',
