export default {
  ...
  modelsPage: {
    ...
    description: 'View the currently available models for each group.',
    searchPlaceholder: 'Search groups or models',
    viewModels: 'View models',
    collapseModels: 'Collapse',
    expandAll: 'Expand all',
    collapseAll: 'Collapse all',
    searchLoading: 'Loading model lists so model-name search can complete.',
    emptyTitle: 'No groups available',
    emptyDescription: 'Your account does not have any groups to show here yet.',
    noMatchTitle: 'No matches found',
    noMatchDescription: 'Try a different group name or model name.',
    modelCount: '{count} models',
    defaultTag: 'Default list',
    defaultHint: 'No custom model mapping was detected for this group, so the default model list is shown.',
    noModels: 'No models are currently available for this group.',
    failedToLoad: 'Failed to load the model list. Please try again.'
  },
  ...
  affiliate: {
    ...
    description: 'Invite customers and track cash and subscription-day rewards from redeem codes',
    ...
    stats: {
      ...
      rebateRateHint: 'Applied to balance-code value or subscription-code days',
      invitedUsers: 'Invited Users',
      customers: 'Qualified / Invited',
      customersHint: 'Qualified customers have redeemed a balance or subscription code',
      availableQuota: 'Available Rebate Quota',
      frozenQuota: 'Frozen',
      frozenQuotaHint: 'Recently earned rebates pending release',
      totalQuota: 'Historical Rebate Quota',
      totalQuotaHint: 'Total cash rebates earned'
    },
    transfer: {
    ...
    invitees: {
      ...
      description: 'Review invite relationships, redemption status, and cash rebates',
    ...
    tips: {
      ...
      line2: 'Balance codes earn {rate} cash rebate; every subscription code earns the same percentage in subscription days.',
      line3: 'Transfer rebate quota to balance at any time.',
      line4: 'Invite at least {count} qualified customers who have redeemed a code. Starting with customer {start}, subsequent redemptions earn rebates.',
      line4NoThreshold: 'There is currently no qualified-customer threshold; all customer redemptions earn rebates.',
      line5: 'Newly earned rebates may have a waiting period before they can be transferred.'
    },
    threshold: {
      notMet: '{remaining} more qualified customers needed to unlock rebates',
      met: 'Rebate eligibility unlocked',
      progress: 'Eligibility progress',
      pendingSummary: 'A customer qualifies after redeeming a positive balance code or subscription code.',
      readySummary: 'Threshold reached. Rewards start with redeemed customer {start}.',
      noThreshold: 'No qualified-customer threshold is configured; eligible redemptions earn rewards immediately.',
      qualifiedCount: 'Qualified customers: {count}/{required}'
    },
    subscriptionDays: {
      title: 'Subscription Days Rebate',
      description: 'Earn proportional days in the matching group whenever a customer redeems any subscription code',
      allTypes: 'All subscription groups',
      empty: 'No subscription days available to claim',
      pendingDays: 'Available days',
      frozenDays: 'Frozen',
      transferButton: 'Claim',
      transferring: 'Claiming...',
      transferSuccess: 'Extended {days} days for {group}'
    },
    records: {
      rebateTitle: 'Rebate Records',
      rebateDescription: 'Complete reward history from balance codes and every subscription group',
      rebateEmpty: 'No rebate records yet',
      transferTitle: 'Withdrawal Records',
      transferDescription: 'History of cash rebates transferred into account balance',
      transferEmpty: 'No withdrawal records yet',
      ...
      columns: {
        ...
        transferredAt: 'Withdrawn At'
      },
      daysReward: '+{days} days',
      source: {
        balanceRedeem: 'Balance code',
        subscriptionRedeem: 'Subscription code',
    ...
    share: {
      ...
      description: 'Share your code or link; new registrations bind automatically'
    }
  },

  imageStudio: {
    title: 'AI Studio',
    description: 'Create, edit, inpaint, and manage image history in one workspace.',
    loadingKeys: 'Loading available API keys...',
    noKeysTitle: 'No active API key is available yet',
    noKeysDescription: 'Create at least one active API key before opening the AI Studio workspace.',
    manageKeys: 'Manage API Keys',
    activeKeyHint: '{name} is currently selected. If its group does not support image models, switch to another key.',
    frameLoading: 'Loading the AI Studio workspace...',
  },
