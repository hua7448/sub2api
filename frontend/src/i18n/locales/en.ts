export default {
  ...
  admin: {
    ...
    imageGallery: {
      ...
      agentModel: 'Agent/Responses default model',
      maxGenerationCount: 'Max generation count',
      allowedModels: 'Allowed models',
      allowedAgentModels: 'Allowed Agent/Responses models',
    ...
    settings: {
      ...
      features: {
        ...
        externalRecharge: {
          title: 'External Recharge Entry',
          description: 'Shows a "Recharge Now" sidebar entry for users and opens the configured recharge page in a new tab.',
          enabled: 'Show Recharge Now entry',
          enabledHint: 'Only controls the external recharge link. Built-in payment pages and orders are unaffected.',
          url: 'Recharge page URL',
          urlPlaceholder: 'https://example.com/recharge',
          urlHint: 'Must be an absolute http(s) URL. User clicks open it in a new tab.',
          urlInvalid: 'Recharge page URL must be an absolute http(s) URL',
          urlRequired: 'Recharge page URL is required when the external recharge entry is enabled',
        },
        availableChannels: {
          title: 'Available Channels',
