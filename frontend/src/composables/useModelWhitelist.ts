...
const antigravityPresetMappings = [
  ...
  { label: 'Opus 4.8', from: 'claude-opus-4-8', to: 'claude-opus-4-6-thinking', color: 'bg-pink-100 text-pink-700 hover:bg-pink-200 dark:bg-pink-900/30 dark:text-pink-400' },
