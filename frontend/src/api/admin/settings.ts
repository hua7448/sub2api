...
export interface SystemSettings {
  ...
  registration_email_provider_alias_disabled: boolean;
  ...
  affiliate_min_qualified_invitees: number;
  ...
  // Provider Hall user page (read-only mirror of provider hall display switch)
