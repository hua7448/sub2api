<template>
  <div class="card">
    <div class="border-b border-gray-100 px-6 py-4">
      <h2 class="text-lg font-medium text-txt-primary">
    ...
    <div class="px-6 py-6">
      ...
      <div v-else-if="status && !status.feature_enabled" class="flex items-center gap-4 py-4">
        <div class="flex-shrink-0 rounded-full bg-cyber-elevated p-3">
          <svg class="h-6 w-6 text-txt-dim" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
      ...
      <div v-else-if="status?.enabled" class="flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex-shrink-0 rounded-full bg-green-100 p-3 bg-green-900/30">
            <svg class="h-6 w-6 text-neon-green text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
          ...
          <div>
            ...
            <p v-if="status.enabled_at" class="text-sm text-txt-secondary">
