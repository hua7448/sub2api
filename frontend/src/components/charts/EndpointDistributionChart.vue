<template>
  <div class="card p-4">
        ...
        <table class="w-full text-xs">
          ...
          <tbody>
            <template v-for="item in displayEndpointStats" :key="item.endpoint">
              ...
              >
                <td class="max-w-[180px] truncate py-1.5 font-medium text-blue-600 hover:text-blue-800 text-blue-400 hover:text-blue-300" :title="item.endpoint">
    ...
    <div v-else class="flex h-48 items-center justify-center text-sm text-txt-secondary">
