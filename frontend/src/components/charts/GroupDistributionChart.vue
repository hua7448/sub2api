          ...
          <tbody>
            <template v-for="group in displayGroupStats" :key="group.group_id">
              <tr
                ...
                :class="enableBreakdown && group.group_id > 0 ? 'cursor-pointer hover:bg-cyber-bg' : ''"
                @click="enableBreakdown && group.group_id > 0 && toggleBreakdown('group', group.group_id)"
              >
                <td
                  class="max-w-[100px] truncate py-1.5 font-medium"
                  :class="group.group_id > 0 ? 'text-blue-600 hover:text-blue-800 text-blue-400 hover:text-blue-300' : 'text-txt-primary'"
