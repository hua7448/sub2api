  ...
  >
    <form id="import-data-form" class="space-y-4" @submit.prevent="handleImport">
      ...
      <div>
        ...
        <div
          class="flex items-center justify-between gap-3 rounded-lg border border-dashed bg-cyber-bg px-4 py-3 transition-colors"
          :class="dragActive ? 'border-primary-500 bg-primary-500/5' : 'border-cyber-border'"
          :title="fileListTitle"
        ...
        >
          <div class="min-w-0">
            <div class="truncate text-sm text-txt-primary">
              {{ selectedFilesLabel || t('admin.accounts.dataImportSelectFile') }}
            </div>
            <div class="text-xs text-txt-secondary">JSON (.json)</div>
          </div>
