      ...
      <div class="flex flex-1 flex-wrap items-end gap-4">
        ...
        <div ref="userSearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[240px]">
          ...
          <button
            ...
            type="button"
            @click="clearUser"
            class="absolute right-2 top-9 text-txt-dim"
          ...
          <div
            ...
            class="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-lg border border-cyber-border bg-cyber-surface shadow-lg"
          >
            <button
              ...
              type="button"
              @click="selectUser(u)"
              class="w-full px-4 py-2 text-left hover:bg-cyber-elevated"
            >
              <span>{{ u.email }}<span v-if="u.deleted" class="ml-1 text-xs text-txt-dim">（{{ t('admin.usage.userDeletedBadge') }}）</span></span>
              <span class="ml-2 text-xs text-txt-dim">#{{ u.id }}</span>
            </button>
          </div>
        </div>
        ...
        <div ref="apiKeySearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[240px]">
          ...
          >
            ...
            >
              ...
              <span class="ml-2 text-xs text-txt-dim">#{{ k.id }}</span>
            </button>
          </div>
        </div>
        ...
        <div ref="accountSearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[220px]">
          ...
          >
            ...
            >
              ...
              <span class="ml-2 text-xs text-txt-dim">#{{ a.id }}</span>
            </button>
          </div>
        </div>
