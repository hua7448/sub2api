      ...
      <div>
        ...
        <div class="flex gap-2">
          <div class="relative flex-1">
            ...
            <button v-if="form.password" type="button" @click="copyPassword" class="absolute right-2 top-1/2 -translate-y-1/2 rounded-lg p-1 transition-colors hover:bg-cyber-elevated" :class="passwordCopied ? 'text-neon-green' : 'text-txt-dim'">
