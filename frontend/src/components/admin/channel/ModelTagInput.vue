<template>
  <div>
    <!-- Tags display -->
    <div class="flex flex-wrap gap-1.5 rounded-lg border border-cyber-border bg-cyber-surface p-2 min-h-[2.5rem]">
      <span
      ...
      >
        ...
        <button
          ...
          class="ml-0.5 rounded-full p-0.5 hover:bg-primary-200 hover:bg-primary-800"
        >
          <Icon name="x" size="xs" />
        </button>
      </span>
      <input
        ...
        v-model="inputValue"
        type="text"
        class="flex-1 min-w-[120px] border-none bg-transparent text-sm outline-none placeholder:text-txt-dim"
    ...
    <p class="mt-1 text-xs text-txt-dim">
