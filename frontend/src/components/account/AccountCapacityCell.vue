  ...
  <div class="flex flex-col gap-1.5">
    ...
    <div class="flex items-center gap-1.5">
      ...
      >
        ...
        <span class="text-txt-dim text-txt-secondary">/</span>
...
const concurrencyClass = computed(() => {
  ...
  if (current > 0) {
    return 'bg-yellow-100 text-yellow-700 bg-yellow-900/30 text-yellow-400'
  }
  return 'bg-cyber-elevated text-txt-secondary bg-gray-800 text-txt-dim'
})
