          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-lg bg-emerald-100 p-1.5 bg-emerald-900/30">
                <svg
                  class="h-4 w-4 text-emerald-600 text-emerald-400"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-lg bg-blue-100 p-1.5 bg-blue-900/30">
                <Icon name="bolt" size="sm" class="text-blue-600 text-blue-400" :stroke-width="2" />
              </div>
            </div>
            <p class="text-2xl font-bold text-txt-primary">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-cyan-100 p-1.5 bg-cyan-900/30">
                <svg
                  class="h-4 w-4 text-cyan-600 text-cyan-400"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
            ...
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-orange-100 p-1.5 bg-orange-900/30">
                <Icon
                  name="fire"
                  size="sm"
                  class="text-orange-600 text-orange-400"
                  :stroke-width="2"
                />
              </div>
              <span class="text-sm font-semibold text-txt-primary">{{
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-teal-100 p-1.5 bg-teal-900/30">
                <Icon name="cube" size="sm" class="text-teal-600 text-teal-400" :stroke-width="2" />
              </div>
              <span class="text-sm font-semibold text-txt-primary">{{
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-rose-100 p-1.5 bg-rose-900/30">
                <Icon name="bolt" size="sm" class="text-rose-600 text-rose-400" :stroke-width="2" />
              </div>
              <span class="text-sm font-semibold text-txt-primary">{{
