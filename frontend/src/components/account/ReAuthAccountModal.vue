    ...
    <div v-if="account" class="space-y-4">
      ...
      >
        <div class="flex items-center gap-3">
          ...
          <div>
            <span class="block font-semibold text-txt-primary">{{
              account.name
            }}</span>
        ...
        <div class="mt-2 flex gap-4">
          <label class="flex cursor-pointer items-center">
            <input
              ...
              type="radio"
              value="oauth"
              class="mr-2 text-neon-cyan focus:ring-neon-cyan"
            />
      ...
      <div v-if="isGemini" class="rounded-lg border border-cyber-border bg-cyber-bg p-4">
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            <span class="block text-sm font-medium text-txt-primary">
              {{
                geminiOAuthType === 'google_one'
                  ? 'Google One'
                  : geminiOAuthType === 'code_assist'
