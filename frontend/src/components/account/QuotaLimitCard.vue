      ...
      <div class="mb-3 flex items-center justify-between">
        ...
        <button
          ...
          :class="[
            ...
            localEnabled ? 'bg-neon-cyan' : 'bg-gray-200'
          ]"
        >
          <span
            :class="[
      ...
      <div v-if="localEnabled" class="space-y-3">
        ...
        <div>
          ...
          <div class="mt-2 flex items-center gap-2">
            <label class="text-xs text-txt-secondary whitespace-nowrap">{{ t('admin.accounts.quotaResetMode') }}</label>
            <select
          ...
          <div v-if="dailyResetMode === 'fixed'" class="mt-2 flex items-center gap-2">
            <label class="text-xs text-txt-secondary whitespace-nowrap">{{ t('admin.accounts.quotaResetHour') }}</label>
            <select
        ...
        <div>
          ...
          <div v-if="weeklyResetMode === 'fixed'" class="mt-2 flex items-center gap-2 flex-wrap">
            <label class="text-xs text-txt-secondary whitespace-nowrap">{{ t('admin.accounts.quotaWeeklyResetDay') }}</label>
            <select
