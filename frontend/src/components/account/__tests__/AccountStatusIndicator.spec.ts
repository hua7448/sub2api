...
describe('AccountStatusIndicator', () => {
  ...
  it('OpenAI Codex 窗口 reset 误写为账号限流时不显示限流中', () => {
    const resetAt = '2099-06-08T12:05:07+08:00'
    const wrapper = mount(AccountStatusIndicator, {
      props: {
        account: makeAccount({
          id: 2151,
          name: 'Queenieshor6711+fonegxg',
          platform: 'openai',
          type: 'oauth',
          rate_limit_reset_at: resetAt,
          extra: {
            codex_5h_used_percent: 99,
            codex_7d_used_percent: 31,
            codex_5h_reset_at: '2099-06-02T15:54:56+08:00',
