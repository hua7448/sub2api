<template>
  <div class="relative" ref="dropdownRef">
    <button
      ...
      :disabled="switching"
      class="toolbar-button flex items-center gap-1.5 px-2 py-1.5 text-sm font-medium"
    ...
    <transition name="dropdown">
      <div
        v-if="isOpen"
        class="absolute right-0 z-50 mt-1 w-32 overflow-hidden rounded-md border-2 border-gray-300 bg-[#fffaf2] shadow-none dark:border-dark-700 dark:bg-dark-800"
      >
        <button
