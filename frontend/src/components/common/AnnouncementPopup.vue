<template>
  <Teleport to="body">
    <Transition name="popup-fade">
      ...
      >
        <div
          class="w-full max-w-[680px] overflow-hidden rounded-3xl bg-cyber-surface shadow-2xl ring-1 ring-black/5 ring-white/10"
          @click.stop
        >
          <!-- Header with warm gradient -->
          <div class="relative overflow-hidden border-b border-amber-100/80 bg-gradient-to-br from-amber-50/80 via-orange-50/50 to-yellow-50/30 px-8 py-6/50 from-amber-900/20 via-orange-900/10 to-yellow-900/5">
            <!-- Decorative background -->
            <div class="absolute right-0 top-0 h-full w-64 bg-gradient-to-l from-orange-100/30 to-transparent from-orange-900/20"></div>
            ...
            <div class="relative z-10">
              ...
              <div class="mb-3 flex items-center gap-2">
                ...
                <span class="inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-amber-500 to-orange-600 px-2.5 py-1 text-xs font-medium shadow-lg shadow-amber-500/30">
              ...
              <!-- Title -->
              <h2 class="mb-2 text-2xl font-bold leading-tight text-txt-primary">
          ...
          <!-- Body -->
          <div class="max-h-[50vh] overflow-y-auto bg-cyber-surface px-8 py-8">
            <div class="relative">
