...
export default function InputBar() {
  ...
  const hasSubmitApiConfig = activeProfile.provider === 'sub2api'
    ? Boolean(activeProfile.sub2apiKeyId)
  ...
  const agentAutoImageCount = appMode === 'agent' && (activeProfile.provider === 'openai' || activeProfile.provider === 'sub2api') && activeProfile.apiMode === 'responses'
  ...
  const streamConcurrentByN = (activeProfile.provider === 'openai' || activeProfile.provider === 'sub2api') && activeProfile.streamImages === true && !agentAutoImageCount && effectiveNValue > 1
